...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.16.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.16.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9/vQ50Y/iALVNuSGfNVdAJm4a5WeZA3F2C3zSZACKbIDqRG4na9FJtZhJ2p6QEwp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.16.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.16.0/index.min.mjs": "sha384-9/vQ50Y/iALVNuSGfNVdAJm4a5WeZA3F2C3zSZACKbIDqRG4na9FJtZhJ2p6QEwp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.16.0/LICENSE
```

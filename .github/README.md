...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.28.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.28.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p/Ti4RpZN/X1Es99G1U7fx1hos5Fi51J3dHg3aJZ+jMFYS8OcyGFuh7s4qUwMK4z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.28.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.28.0/index.min.mjs": "sha384-p/Ti4RpZN/X1Es99G1U7fx1hos5Fi51J3dHg3aJZ+jMFYS8OcyGFuh7s4qUwMK4z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.28.0/LICENSE
```

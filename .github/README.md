...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.940.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.940.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-n4Z0Zmg0YjxbQZGupuwVQp4zqT4gCO4kmPr9UmjrYuDcOfuSsDlk7tZodqx+EsJl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.940.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.940.0/index.min.mjs": "sha384-n4Z0Zmg0YjxbQZGupuwVQp4zqT4gCO4kmPr9UmjrYuDcOfuSsDlk7tZodqx+EsJl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.940.0/LICENSE
```

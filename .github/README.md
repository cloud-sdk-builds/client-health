...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.145.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.145.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kJDD+ce10+f0AkVQ22VvBe/5QnpQf/GYgrpP+YcgNQ7HJ9Ml3+hKYvKei6hh5JmN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.145.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.145.0/index.min.mjs": "sha384-kJDD+ce10+f0AkVQ22VvBe/5QnpQf/GYgrpP+YcgNQ7HJ9Ml3+hKYvKei6hh5JmN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.145.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.30.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.30.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+L5tDWKSTIZfjv3G2tw4gi8zYOvR9/F56Amoa66PqrYA39n5LKW7O/zBo3XwZfjM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.30.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.30.0/index.min.mjs": "sha384-+L5tDWKSTIZfjv3G2tw4gi8zYOvR9/F56Amoa66PqrYA39n5LKW7O/zBo3XwZfjM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.30.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.85.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.85.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-q91JmCIonrpmLoUDsZ/yzdYIOMgu6jPoYF4mt8jG0JqLxkkCWk6Ep6TKyXp+kzwx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.85.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.85.0/index.min.mjs": "sha384-q91JmCIonrpmLoUDsZ/yzdYIOMgu6jPoYF4mt8jG0JqLxkkCWk6Ep6TKyXp+kzwx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.85.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.908.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.908.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0hxVRifGrKd2T89RwqflISDrlPNr9B0p+c+mNcx0QafhaXoZUYgIPlFsVk1pCAGY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.908.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.908.0/index.min.mjs": "sha384-0hxVRifGrKd2T89RwqflISDrlPNr9B0p+c+mNcx0QafhaXoZUYgIPlFsVk1pCAGY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.908.0/LICENSE
```

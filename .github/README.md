...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.714.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.714.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-clfcgUPpB4n4HSI4bVHZD/Mrk9JNV22kRsu+AO0DCsyuTr7gKYqmZ8aqW4PD/iq3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.714.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.714.0/index.min.mjs": "sha384-clfcgUPpB4n4HSI4bVHZD/Mrk9JNV22kRsu+AO0DCsyuTr7gKYqmZ8aqW4PD/iq3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.714.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.744.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.744.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GMQatcFYElkC5Mbkzgj4KPL8DhuxJsWb066WWdhenhQirSyviXdoARHtD4MlTk0f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.744.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.744.0/index.min.mjs": "sha384-GMQatcFYElkC5Mbkzgj4KPL8DhuxJsWb066WWdhenhQirSyviXdoARHtD4MlTk0f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.744.0/LICENSE
```

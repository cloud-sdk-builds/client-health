...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.292.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.292.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-j2a4CH7nsx7u/v/ueIe17cgYFitc6VpWd/lH4IMKL9VYyN+b/GMV5meV1RA3Qq9/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.292.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.292.0/index.min.mjs": "sha384-j2a4CH7nsx7u/v/ueIe17cgYFitc6VpWd/lH4IMKL9VYyN+b/GMV5meV1RA3Qq9/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.292.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.257.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.257.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-44dFLk1K2PGYR+884sXqq0NImNochglFFn2XsNfcZSFw5LSRSXxtWDtJRD+NS1Zy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.257.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.257.0/index.min.mjs": "sha384-44dFLk1K2PGYR+884sXqq0NImNochglFFn2XsNfcZSFw5LSRSXxtWDtJRD+NS1Zy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.257.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.476.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.476.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-z0PIufoiGp6THAYwNSsYjXYCdC4ge2riO4Sp+qTdIKUd9dfuxa0gPDeGc8pZjI9S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.476.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.476.0/index.min.mjs": "sha384-z0PIufoiGp6THAYwNSsYjXYCdC4ge2riO4Sp+qTdIKUd9dfuxa0gPDeGc8pZjI9S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.476.0/LICENSE
```

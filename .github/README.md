...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.918.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.918.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5IHdcv172SsIP8sShPNbPitG+vPpk8AcZaHppx2YaH0PJjG3KADE0WNO372Hfsxd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.918.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.918.0/index.min.mjs": "sha384-5IHdcv172SsIP8sShPNbPitG+vPpk8AcZaHppx2YaH0PJjG3KADE0WNO372Hfsxd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.918.0/LICENSE
```

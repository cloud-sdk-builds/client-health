...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.927.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.927.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OnCJqa2cwG/L+as3+zpfcLSQ/3lW/n3kHyGhGcNjffNKoGfeoJFZ8tUeHLi0L9Vw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.927.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.927.0/index.min.mjs": "sha384-OnCJqa2cwG/L+as3+zpfcLSQ/3lW/n3kHyGhGcNjffNKoGfeoJFZ8tUeHLi0L9Vw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.927.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.803.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.803.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RTuIpMFJ9F36WclOj0HOKaF5GT6TYLEzvFpWcgH/+7OT65HlJ1yNC3unsT01QrUG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.803.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.803.0/index.min.mjs": "sha384-RTuIpMFJ9F36WclOj0HOKaF5GT6TYLEzvFpWcgH/+7OT65HlJ1yNC3unsT01QrUG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.803.0/LICENSE
```

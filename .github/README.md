...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.335.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.335.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L9sFYp2QU+uy7w7r++6yrIsj8z8l1bnGJG07jSweybSIhz81b6UKZNKduAA1v+k2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.335.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.335.0/index.min.mjs": "sha384-L9sFYp2QU+uy7w7r++6yrIsj8z8l1bnGJG07jSweybSIhz81b6UKZNKduAA1v+k2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.335.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.241.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.241.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-z2yrIpYG/c+giaEdO732kPPwyu1YaQuJjPH4Q4PzZYvkRfMPSfwqylbUNLhq6nJt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.241.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.241.0/index.min.mjs": "sha384-z2yrIpYG/c+giaEdO732kPPwyu1YaQuJjPH4Q4PzZYvkRfMPSfwqylbUNLhq6nJt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.241.0/LICENSE
```

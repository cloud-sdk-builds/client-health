...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.787.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.787.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zJeZ86AhqeTtaAYI5oojFxcDdpTNky2VuN2jFGldvJgcsHJNpa9uI0ndJ1HCra/r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.787.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.787.0/index.min.mjs": "sha384-zJeZ86AhqeTtaAYI5oojFxcDdpTNky2VuN2jFGldvJgcsHJNpa9uI0ndJ1HCra/r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.787.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.300.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.300.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oe93W+qw5cK7DuVxIeasDqeRU6SCU5PWVjjFAqCZDw4huWgLJpKGsbLZheSHxLWy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.300.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.300.0/index.min.mjs": "sha384-oe93W+qw5cK7DuVxIeasDqeRU6SCU5PWVjjFAqCZDw4huWgLJpKGsbLZheSHxLWy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.300.0/LICENSE
```

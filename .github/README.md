...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.485.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.485.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pgFmzf0whvW3YmwDAJgEo+5xjq9hiERglC5HMj7jGXVOZNW6ZzVfAF+mfoBpjfbV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.485.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.485.0/index.min.mjs": "sha384-pgFmzf0whvW3YmwDAJgEo+5xjq9hiERglC5HMj7jGXVOZNW6ZzVfAF+mfoBpjfbV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.485.0/LICENSE
```

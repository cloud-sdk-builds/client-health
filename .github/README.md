...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.858.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.858.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pp9PqLUrpuhSISFidLIcgZo6qCQD8dju3K5mtdpL5G0fPQS+koow9BbUjxh0y/zm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.858.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.858.0/index.min.mjs": "sha384-pp9PqLUrpuhSISFidLIcgZo6qCQD8dju3K5mtdpL5G0fPQS+koow9BbUjxh0y/zm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.858.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.980.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.980.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OLcTuwAH9d+6xsYPOmlVU8P7Yuk2YCP0UM4gifSEWtaY+ruYCGebSzx2bTqt2K1g
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.980.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.980.0/index.min.mjs": "sha384-OLcTuwAH9d+6xsYPOmlVU8P7Yuk2YCP0UM4gifSEWtaY+ruYCGebSzx2bTqt2K1g"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.980.0/LICENSE
```

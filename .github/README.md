...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.699.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.699.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FzAzjF5MceKrnRT9BgNgxCnhTN9DdOodRo4/5WQnbXUP+Jb3CF9mEJFd6g3NyLd+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.699.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.699.0/index.min.mjs": "sha384-FzAzjF5MceKrnRT9BgNgxCnhTN9DdOodRo4/5WQnbXUP+Jb3CF9mEJFd6g3NyLd+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.699.0/LICENSE
```

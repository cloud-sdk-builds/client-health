...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.582.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.582.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KJU37eo70DeeXQ7f4hlyUtlQMC5vqHzplbAWMPuE4SISXaOwJ47aNuk3Jo3LfC8B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.582.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.582.0/index.min.mjs": "sha384-KJU37eo70DeeXQ7f4hlyUtlQMC5vqHzplbAWMPuE4SISXaOwJ47aNuk3Jo3LfC8B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.582.0/LICENSE
```

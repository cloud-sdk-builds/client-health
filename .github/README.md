...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.408.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.408.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-E74EICGpdqKNB/vWfiGJWe89Mhy1K1+wI6xWTbB6NtSvr0f7R2OTQ+EO6q2+zaeQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.408.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.408.0/index.min.mjs": "sha384-E74EICGpdqKNB/vWfiGJWe89Mhy1K1+wI6xWTbB6NtSvr0f7R2OTQ+EO6q2+zaeQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.408.0/LICENSE
```

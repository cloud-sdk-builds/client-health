...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.245.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.245.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uRo0YIv77MWo5XnBU9Fv1km63vfNHg+15AUb9afiYklVmVAjtuVigKdmOeK28MgQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.245.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.245.0/index.min.mjs": "sha384-uRo0YIv77MWo5XnBU9Fv1km63vfNHg+15AUb9afiYklVmVAjtuVigKdmOeK28MgQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.245.0/LICENSE
```

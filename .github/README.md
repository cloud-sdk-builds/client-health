...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.484.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.484.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JKPfD3hiG1sl0PPrkuOqYt5xfTrR/TQEMekqCqiHY8Y8xCXw2c9K7lhZGlXJpHQY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.484.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.484.0/index.min.mjs": "sha384-JKPfD3hiG1sl0PPrkuOqYt5xfTrR/TQEMekqCqiHY8Y8xCXw2c9K7lhZGlXJpHQY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.484.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.515.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.515.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0Z1uDvcZuSNxZNRbkWBfzbMTDcC1LPYjAnT9E9Dg7L/gDrCWX7UxR/K7Wsm6ZFJV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.515.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.515.0/index.min.mjs": "sha384-0Z1uDvcZuSNxZNRbkWBfzbMTDcC1LPYjAnT9E9Dg7L/gDrCWX7UxR/K7Wsm6ZFJV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.515.0/LICENSE
```

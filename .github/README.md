...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.391.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.391.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ed809StK5aBD/57HgkN57s2GMnM9re5z8uXpdmbbdm9gL55EZMB85NZXMdy28L62
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.391.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.391.0/index.min.mjs": "sha384-Ed809StK5aBD/57HgkN57s2GMnM9re5z8uXpdmbbdm9gL55EZMB85NZXMdy28L62"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.391.0/LICENSE
```

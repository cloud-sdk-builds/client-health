...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.413.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.413.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2UA9b40FxKg2f85oXv7B5JbITj8FIy5r5LgZpZkLv4zgI++02QBdVZTZXgNOiP5m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.413.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.413.0/index.min.mjs": "sha384-2UA9b40FxKg2f85oXv7B5JbITj8FIy5r5LgZpZkLv4zgI++02QBdVZTZXgNOiP5m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.413.0/LICENSE
```

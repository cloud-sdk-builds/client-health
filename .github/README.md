...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.222.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.222.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+JHztQDA7waAPJEe9GWHkyrZWQwdlru9GgFp1MH9fwW8PI4qE/jCXLvHVa8OsMoA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.222.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.222.0/index.min.mjs": "sha384-+JHztQDA7waAPJEe9GWHkyrZWQwdlru9GgFp1MH9fwW8PI4qE/jCXLvHVa8OsMoA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.222.0/LICENSE
```

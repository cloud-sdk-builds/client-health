...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.52.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.52.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-q2nnmLX6qlsLsKK6SDppnQBrKL0wEgCRyj98HtT9B7KS4NBLlc6+wBFt+HV+dW1a
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.52.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.52.0/index.min.mjs": "sha384-q2nnmLX6qlsLsKK6SDppnQBrKL0wEgCRyj98HtT9B7KS4NBLlc6+wBFt+HV+dW1a"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.52.0/LICENSE
```

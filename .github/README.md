...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.46.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.46.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-q6tgkthn5A2UT1l4aZjWcF74SARRNPh8882FvsRshwLze7ubglFW2Lv7TzwjEUAA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.46.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.46.0/index.min.mjs": "sha384-q6tgkthn5A2UT1l4aZjWcF74SARRNPh8882FvsRshwLze7ubglFW2Lv7TzwjEUAA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.46.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.357.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.357.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4TeZX46wYucuNMWc3Hcf5QWQnwkSEe0O57AnMQb4CR0K/kZJ5jYHbSQ2rohN/vlW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.357.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.357.0/index.min.mjs": "sha384-4TeZX46wYucuNMWc3Hcf5QWQnwkSEe0O57AnMQb4CR0K/kZJ5jYHbSQ2rohN/vlW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.357.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.575.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.575.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oFR6qWjXC6x6oF0m9OEvHnZcRbhJK85whdQoNRQQhvvM+EspBvZ1BuBTJyDknKIK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.575.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.575.0/index.min.mjs": "sha384-oFR6qWjXC6x6oF0m9OEvHnZcRbhJK85whdQoNRQQhvvM+EspBvZ1BuBTJyDknKIK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.575.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.596.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.596.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qETkg42fZ5sA1w4Y2HX5MqLWOiMCBvz08OpJy+5UfFpriv3P8mWSOIwvYQDO0423
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.596.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.596.0/index.min.mjs": "sha384-qETkg42fZ5sA1w4Y2HX5MqLWOiMCBvz08OpJy+5UfFpriv3P8mWSOIwvYQDO0423"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.596.0/LICENSE
```

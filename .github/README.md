...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.209.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.209.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0/+9obFbA8sfBcikqLUsXz5bjewpqN+87F6yB06uUL1kCY/2HbqyQ5SjUCb0i6vK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.209.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.209.0/index.min.mjs": "sha384-0/+9obFbA8sfBcikqLUsXz5bjewpqN+87F6yB06uUL1kCY/2HbqyQ5SjUCb0i6vK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.209.0/LICENSE
```

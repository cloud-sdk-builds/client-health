...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.521.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.521.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AyZFn+eUndz5W7P2MplKY7UZYhSwlGnH0f5sJDumMR1d95QzDBQY2ndS1B77zNwe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.521.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.521.0/index.min.mjs": "sha384-AyZFn+eUndz5W7P2MplKY7UZYhSwlGnH0f5sJDumMR1d95QzDBQY2ndS1B77zNwe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.521.0/LICENSE
```

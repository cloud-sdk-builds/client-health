...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.975.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.975.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-juvGHV6uo2qWk8s9gNBOk9l9mRdh8ktC6YadOdqYwyXsCPCabdERd972NklTz1D2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.975.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.975.0/index.min.mjs": "sha384-juvGHV6uo2qWk8s9gNBOk9l9mRdh8ktC6YadOdqYwyXsCPCabdERd972NklTz1D2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.975.0/LICENSE
```

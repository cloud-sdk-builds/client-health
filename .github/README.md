...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.462.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.462.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-45otEAF8qIkZRy0lRqM1sETdBj80NSniSgXTd+JX8csUcKPUoc9KJJR3jHoXpank
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.462.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.462.0/index.min.mjs": "sha384-45otEAF8qIkZRy0lRqM1sETdBj80NSniSgXTd+JX8csUcKPUoc9KJJR3jHoXpank"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.462.0/LICENSE
```

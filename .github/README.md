...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.387.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.387.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2LGLZa2jmO9+1ogLk4THBt8eTVRgFCMJQUdshJ+l/pENybQEyu4b+mJAngFQtSGI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.387.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.387.0/index.min.mjs": "sha384-2LGLZa2jmO9+1ogLk4THBt8eTVRgFCMJQUdshJ+l/pENybQEyu4b+mJAngFQtSGI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.387.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.956.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.956.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZvC98WOYZMfa4BQwUt/A0ztKVZ9++aztWGRgRfKIqKXoQS3z+MaZfLb73PWh8GO/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.956.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.956.0/index.min.mjs": "sha384-ZvC98WOYZMfa4BQwUt/A0ztKVZ9++aztWGRgRfKIqKXoQS3z+MaZfLb73PWh8GO/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.956.0/LICENSE
```

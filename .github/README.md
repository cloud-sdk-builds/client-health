...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.624.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.624.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9o6nZY9JxOmsROYHEsMNPQxFS8F2/VPk5fHUkVEQrr1+Fp5C0Te3syupS8MESqSS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.624.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.624.0/index.min.mjs": "sha384-9o6nZY9JxOmsROYHEsMNPQxFS8F2/VPk5fHUkVEQrr1+Fp5C0Te3syupS8MESqSS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.624.0/LICENSE
```

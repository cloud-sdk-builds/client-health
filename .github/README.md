...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.465.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.465.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EdWVHSg5ElCq1mlp9MFvc4kjtJwRDyEqQzLQj/KRsdfaZ9fFOep33XYnFXDfW7LP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.465.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.465.0/index.min.mjs": "sha384-EdWVHSg5ElCq1mlp9MFvc4kjtJwRDyEqQzLQj/KRsdfaZ9fFOep33XYnFXDfW7LP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.465.0/LICENSE
```

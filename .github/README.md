...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.658.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.658.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-8VMzcW4Jf1Mo1JsCaepZ4t5IWIhFcHiXtavhQ8jk1Mq0js2ctPP1uBXH4+X+XUpG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.658.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.658.1/index.min.mjs": "sha384-8VMzcW4Jf1Mo1JsCaepZ4t5IWIhFcHiXtavhQ8jk1Mq0js2ctPP1uBXH4+X+XUpG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.658.1/LICENSE
```

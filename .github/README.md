...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.282.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.282.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pj1xfXg0o/rL2DcYeI3WLZ2n3Ugi6gZrcKXhnjPFL4AuAwBkyDWxEkVPw27MaIzX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.282.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.282.0/index.min.mjs": "sha384-pj1xfXg0o/rL2DcYeI3WLZ2n3Ugi6gZrcKXhnjPFL4AuAwBkyDWxEkVPw27MaIzX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.282.0/LICENSE
```

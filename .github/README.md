...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.931.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.931.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A0hQc5SHBGUW0C82Ol7w0FHhjAkaJt7F33bk88gDz0+nlDmyGNtWh7inrZDvMS9w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.931.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.931.0/index.min.mjs": "sha384-A0hQc5SHBGUW0C82Ol7w0FHhjAkaJt7F33bk88gDz0+nlDmyGNtWh7inrZDvMS9w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.931.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.36.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.36.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sC2kMy+KScwPrEdWqhyPF+DIFZKIi1n7gXHnY8IPV4lMrCQ3lKQCx/f3xraCj86h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.36.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.36.0/index.min.mjs": "sha384-sC2kMy+KScwPrEdWqhyPF+DIFZKIi1n7gXHnY8IPV4lMrCQ3lKQCx/f3xraCj86h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.36.0/LICENSE
```

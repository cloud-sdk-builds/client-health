...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.910.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.910.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RIScqpmSQlq+X7nA4VDAiBNr98ktA16M0UuffgOeAjBlOqovvRQ38cr++EB+l4IJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.910.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.910.0/index.min.mjs": "sha384-RIScqpmSQlq+X7nA4VDAiBNr98ktA16M0UuffgOeAjBlOqovvRQ38cr++EB+l4IJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.910.0/LICENSE
```

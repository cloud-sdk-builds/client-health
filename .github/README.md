...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.873.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.873.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ii8oGYa+P5eksMgBEpGoWsPTp9uAUGA+1Kyh5NxW24w4saSTOfyJGeEkqKMlTws5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.873.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.873.0/index.min.mjs": "sha384-Ii8oGYa+P5eksMgBEpGoWsPTp9uAUGA+1Kyh5NxW24w4saSTOfyJGeEkqKMlTws5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.873.0/LICENSE
```

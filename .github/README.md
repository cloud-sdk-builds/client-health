...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.928.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.928.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ni7kK8hjhw0/FIQKDxHeogJH08wUQkSkrvCD+6vzsVQF0xIbHL3eDb0dLAD/tNDR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.928.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.928.0/index.min.mjs": "sha384-ni7kK8hjhw0/FIQKDxHeogJH08wUQkSkrvCD+6vzsVQF0xIbHL3eDb0dLAD/tNDR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.928.0/LICENSE
```

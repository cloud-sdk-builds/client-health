...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.664.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.664.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A5CYbDvy6YM+nZeKRPPnIJiKINH4NPbkrueLLhAps9FQTH0c0Ld5ALmYFKs6IHOx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.664.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.664.0/index.min.mjs": "sha384-A5CYbDvy6YM+nZeKRPPnIJiKINH4NPbkrueLLhAps9FQTH0c0Ld5ALmYFKs6IHOx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.664.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.726.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.726.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-lUvMWvD5aIQVZF8b177Ck37aSlcl6C1bkXHy46yMBjfcfMUHNs+40CPLWq8YKckI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.726.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.726.1/index.min.mjs": "sha384-lUvMWvD5aIQVZF8b177Ck37aSlcl6C1bkXHy46yMBjfcfMUHNs+40CPLWq8YKckI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.726.1/LICENSE
```

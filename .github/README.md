...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.796.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.796.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Oh7g6sV81WIMbuUepXVJqK1RZot8pvBMFGeBpvtJq38IzTMBVo8Z15LrugXQKDPd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.796.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.796.0/index.min.mjs": "sha384-Oh7g6sV81WIMbuUepXVJqK1RZot8pvBMFGeBpvtJq38IzTMBVo8Z15LrugXQKDPd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.796.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.272.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.272.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K7TCWS0RQiNPYegi/P2qzb7fptG1mfrPV5N+I3z76inp9XfqBntoZ2ocqfnMhg7s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.272.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.272.0/index.min.mjs": "sha384-K7TCWS0RQiNPYegi/P2qzb7fptG1mfrPV5N+I3z76inp9XfqBntoZ2ocqfnMhg7s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.272.0/LICENSE
```

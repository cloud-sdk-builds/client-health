...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.294.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.294.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l/I5LI8sp9SbjyKkCemWhApqCmbcr/Ha7oqPH4N5PqKvp56ZucwYysLqGlzUsvUO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.294.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.294.0/index.min.mjs": "sha384-l/I5LI8sp9SbjyKkCemWhApqCmbcr/Ha7oqPH4N5PqKvp56ZucwYysLqGlzUsvUO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.294.0/LICENSE
```

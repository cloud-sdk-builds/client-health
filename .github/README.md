...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.127.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.127.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sUfJgdNxivDD5GtDHvJ3Ib6w/sAu/Osee1b9+6hrNL2qlwK/aIjlLMYwxv2fmCwS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.127.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.127.0/index.min.mjs": "sha384-sUfJgdNxivDD5GtDHvJ3Ib6w/sAu/Osee1b9+6hrNL2qlwK/aIjlLMYwxv2fmCwS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.127.0/LICENSE
```

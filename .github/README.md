...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.388.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.388.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-INeFg+VIS76b2SaGogVdFPAU7YJh4kw95jBhTArH5e1DSKnSR1EErqB1gKzl9PK7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.388.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.388.0/index.min.mjs": "sha384-INeFg+VIS76b2SaGogVdFPAU7YJh4kw95jBhTArH5e1DSKnSR1EErqB1gKzl9PK7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.388.0/LICENSE
```

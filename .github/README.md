...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.501.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.501.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-g5qW5XlhWkV7t5USyLG+rFOCM4CEOecAK+eFWJSsknmf/90CV3RDWajVYliQd4Dm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.501.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.501.0/index.min.mjs": "sha384-g5qW5XlhWkV7t5USyLG+rFOCM4CEOecAK+eFWJSsknmf/90CV3RDWajVYliQd4Dm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.501.0/LICENSE
```

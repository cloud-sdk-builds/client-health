...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.382.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.382.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2mwqaKKleU7n5hy980iGlAVzhi9+sRt8LH2/QRwowFdhVmlvyAbzQ+xFa0i2tjiE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.382.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.382.0/index.min.mjs": "sha384-2mwqaKKleU7n5hy980iGlAVzhi9+sRt8LH2/QRwowFdhVmlvyAbzQ+xFa0i2tjiE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.382.0/LICENSE
```

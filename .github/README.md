...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.438.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.438.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6cUtp0DAYprukAkoEExwFXj6t1to5DB1ZqVxszzJYJfUbEVPVwX0Zipr3+t2NFQ/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.438.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.438.0/index.min.mjs": "sha384-6cUtp0DAYprukAkoEExwFXj6t1to5DB1ZqVxszzJYJfUbEVPVwX0Zipr3+t2NFQ/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.438.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.509.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.509.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rRhNPkvsDt4bp6k6EpCsWIhSxHZos4/jS76cn80infTYmhysY6TqbtF9OZYqWEwk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.509.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.509.0/index.min.mjs": "sha384-rRhNPkvsDt4bp6k6EpCsWIhSxHZos4/jS76cn80infTYmhysY6TqbtF9OZYqWEwk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.509.0/LICENSE
```

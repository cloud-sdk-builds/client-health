...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.192.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.192.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6keAH1wl8kDwZ6Dz4hHSD0a7V++Wkf4uCyE5oxAVr5MwvPCY788hTGC1wvDvBsfE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.192.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.192.0/index.min.mjs": "sha384-6keAH1wl8kDwZ6Dz4hHSD0a7V++Wkf4uCyE5oxAVr5MwvPCY788hTGC1wvDvBsfE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.192.0/LICENSE
```

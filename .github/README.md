...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.564.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.564.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d4uy9/KQx1+pPifwimEA9Jgyzu5NqIohlTYdQdIrcX/ovt/lGZzKtviPqMzN+0PR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.564.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.564.0/index.min.mjs": "sha384-d4uy9/KQx1+pPifwimEA9Jgyzu5NqIohlTYdQdIrcX/ovt/lGZzKtviPqMzN+0PR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.564.0/LICENSE
```

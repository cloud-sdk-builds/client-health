...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.496.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.496.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uc6LRsRquHEwFd7cpevCMfiUKWueOWmDDPIzBnVBlhepgOjcJbOrkt2lB1H1lqvh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.496.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.496.0/index.min.mjs": "sha384-uc6LRsRquHEwFd7cpevCMfiUKWueOWmDDPIzBnVBlhepgOjcJbOrkt2lB1H1lqvh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.496.0/LICENSE
```

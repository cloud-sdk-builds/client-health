...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.279.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.279.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KYEeYnOt/mUbYYCkzphXrHewBv6NNHf/I7yvfqxgAXPyh1xiIzsv3keCcPkK4nco
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.279.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.279.0/index.min.mjs": "sha384-KYEeYnOt/mUbYYCkzphXrHewBv6NNHf/I7yvfqxgAXPyh1xiIzsv3keCcPkK4nco"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.279.0/LICENSE
```

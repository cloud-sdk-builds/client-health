...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.799.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.799.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BgpdnytUA8jx21U9ZcraJJXYWFKXDLE5eIInQz4u7mx3Lpi5Oi9LEOq3Hi6oeeK0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.799.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.799.0/index.min.mjs": "sha384-BgpdnytUA8jx21U9ZcraJJXYWFKXDLE5eIInQz4u7mx3Lpi5Oi9LEOq3Hi6oeeK0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.799.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.137.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.137.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pAyOoLGyP+Eb+q0PhxjHvUGHy88T/p1Q4yiDlfzGvSI+ocJ6jjJSHniLZrG3Fr3Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.137.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.137.0/index.min.mjs": "sha384-pAyOoLGyP+Eb+q0PhxjHvUGHy88T/p1Q4yiDlfzGvSI+ocJ6jjJSHniLZrG3Fr3Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.137.0/LICENSE
```

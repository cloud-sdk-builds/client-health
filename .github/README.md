...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1027.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1027.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Sl1HeXVHpgajSytHhkaFb7BCltC7pV0x/pde5T9QH5vIson45Q0Z6n1QKgq+/iRA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1027.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1027.0/index.min.mjs": "sha384-Sl1HeXVHpgajSytHhkaFb7BCltC7pV0x/pde5T9QH5vIson45Q0Z6n1QKgq+/iRA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1027.0/LICENSE
```

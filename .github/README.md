...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.616.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.616.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rQtltGmz9yp+KHXa32ONpmil+Im6SjIsvYuMkB2FovjmzMxdN08boQ+f2RZ46alR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.616.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.616.0/index.min.mjs": "sha384-rQtltGmz9yp+KHXa32ONpmil+Im6SjIsvYuMkB2FovjmzMxdN08boQ+f2RZ46alR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.616.0/LICENSE
```

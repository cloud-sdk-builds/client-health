...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.404.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.404.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fkEN5Qpx887/Vfau6zg2bX9cXH/bvJ+F5pa7e51oEJKpsDTnUXZ2QD81O9im/Sdi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.404.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.404.0/index.min.mjs": "sha384-fkEN5Qpx887/Vfau6zg2bX9cXH/bvJ+F5pa7e51oEJKpsDTnUXZ2QD81O9im/Sdi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.404.0/LICENSE
```

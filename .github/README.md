...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.962.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.962.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Oy32MkIPtE0ApI5GJmDh7zQ7rQBKDCucbD1u0JXOqKC1so9UVn8rmLOP6OyW+KMb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.962.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.962.0/index.min.mjs": "sha384-Oy32MkIPtE0ApI5GJmDh7zQ7rQBKDCucbD1u0JXOqKC1so9UVn8rmLOP6OyW+KMb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.962.0/LICENSE
```

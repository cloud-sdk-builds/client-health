...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.47.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.47.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dBsTpFTXSDwrAXH3KJlv2AT7GHRbpmxn3H1je8va1tlmEUVWIC43KPaLNmJOPg6S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.47.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.47.0/index.min.mjs": "sha384-dBsTpFTXSDwrAXH3KJlv2AT7GHRbpmxn3H1je8va1tlmEUVWIC43KPaLNmJOPg6S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.47.0/LICENSE
```

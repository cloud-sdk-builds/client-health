...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.409.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.409.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d91Sf5FVVrNpUlAakrzs36Uu/4rZFFnPM+uWxgStYKSGhoI9ztrhBUL8O0MRwQ4+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.409.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.409.0/index.min.mjs": "sha384-d91Sf5FVVrNpUlAakrzs36Uu/4rZFFnPM+uWxgStYKSGhoI9ztrhBUL8O0MRwQ4+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.409.0/LICENSE
```

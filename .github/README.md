...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1005.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1005.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wHoGH5+a3ePVo8kmjMxGuYg/mUlWq7kpgJ/KiriV8kTzCxPk9hwBo7gOaety5CIZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1005.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1005.0/index.min.mjs": "sha384-wHoGH5+a3ePVo8kmjMxGuYg/mUlWq7kpgJ/KiriV8kTzCxPk9hwBo7gOaety5CIZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1005.0/LICENSE
```

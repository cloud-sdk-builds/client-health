...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.925.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.925.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1xWF1nMUL8wpQVjPCAsNYDPPF6vnNpQo/NvENasl/EEGSA3Bbe/tqSrkaOfOoXCt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.925.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.925.0/index.min.mjs": "sha384-1xWF1nMUL8wpQVjPCAsNYDPPF6vnNpQo/NvENasl/EEGSA3Bbe/tqSrkaOfOoXCt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.925.0/LICENSE
```

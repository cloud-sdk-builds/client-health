...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.665.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.665.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2yUrJbni34nMF32A0yjYACr+74/xD7UQ+X65U6jsrinXxviT63FFEpzfnmcHClth
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.665.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.665.0/index.min.mjs": "sha384-2yUrJbni34nMF32A0yjYACr+74/xD7UQ+X65U6jsrinXxviT63FFEpzfnmcHClth"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.665.0/LICENSE
```

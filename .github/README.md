...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.42.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.42.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-74GaAuD4+ft2ytdKk+O9P5xt3s3mKuTcgsPq57KgZPYKo8knav/Ai4ms4unfBe9g
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.42.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.42.0/index.min.mjs": "sha384-74GaAuD4+ft2ytdKk+O9P5xt3s3mKuTcgsPq57KgZPYKo8knav/Ai4ms4unfBe9g"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.42.0/LICENSE
```

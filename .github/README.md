...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.932.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.932.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iF03EcuUE4xWTqA/Jz1zAMK5uXNmPRBttkVWKA/HSo9IpRT/fVH4BtqpElfz785L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.932.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.932.0/index.min.mjs": "sha384-iF03EcuUE4xWTqA/Jz1zAMK5uXNmPRBttkVWKA/HSo9IpRT/fVH4BtqpElfz785L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.932.0/LICENSE
```

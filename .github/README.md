...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.859.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.859.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k+fhNCKufSS1C30aOqEHjhqEJP0lhQijo+xSl/9SL50UKfVobFHbVjcVSBllFM7Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.859.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.859.0/index.min.mjs": "sha384-k+fhNCKufSS1C30aOqEHjhqEJP0lhQijo+xSl/9SL50UKfVobFHbVjcVSBllFM7Z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.859.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1023.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1023.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cLLhUrZD+uOTV7fFZzrpwmgrJrUUy9XQtqJLlJpV+k7Tox6u0p6pJfl/LJnVJErz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1023.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1023.0/index.min.mjs": "sha384-cLLhUrZD+uOTV7fFZzrpwmgrJrUUy9XQtqJLlJpV+k7Tox6u0p6pJfl/LJnVJErz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1023.0/LICENSE
```

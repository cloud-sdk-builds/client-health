...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.169.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.169.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bN0y6ALJEt/jJJcvqd7s4qkjCJq38XHEPz6xClrcv8JJOutVmkb2XPKajoXG0syk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.169.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.169.0/index.min.mjs": "sha384-bN0y6ALJEt/jJJcvqd7s4qkjCJq38XHEPz6xClrcv8JJOutVmkb2XPKajoXG0syk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.169.0/LICENSE
```

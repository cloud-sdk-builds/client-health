...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.95.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.95.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EvK3bRS8AO2BdivjWg9OIGpRjbS7LEk+uPvVbUW7yaycLo4J094t/L7JLXK1rJST
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.95.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.95.0/index.min.mjs": "sha384-EvK3bRS8AO2BdivjWg9OIGpRjbS7LEk+uPvVbUW7yaycLo4J094t/L7JLXK1rJST"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.95.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.890.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.890.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v2UDk/QJbnje7EUzUrAtF701HHo0fs3ixxUlKTdcyHl2xwvEDntWK1eWCOQBB573
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.890.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.890.0/index.min.mjs": "sha384-v2UDk/QJbnje7EUzUrAtF701HHo0fs3ixxUlKTdcyHl2xwvEDntWK1eWCOQBB573"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.890.0/LICENSE
```

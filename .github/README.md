...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.345.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.345.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zKP3rVFfFziLUf+729q6SRB+TCZNRnl+okMG4D1vKVYsd8skrzF8Bq3FqjAW5bN7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.345.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.345.0/index.min.mjs": "sha384-zKP3rVFfFziLUf+729q6SRB+TCZNRnl+okMG4D1vKVYsd8skrzF8Bq3FqjAW5bN7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.345.0/LICENSE
```

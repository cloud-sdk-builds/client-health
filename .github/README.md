...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.782.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.782.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-csBZEFHkWA2m4GsOR2OEmvBujz3CNVf+0hqF1lc6g8nenQPYK+NdL0brzc/FJCle
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.782.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.782.0/index.min.mjs": "sha384-csBZEFHkWA2m4GsOR2OEmvBujz3CNVf+0hqF1lc6g8nenQPYK+NdL0brzc/FJCle"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.782.0/LICENSE
```

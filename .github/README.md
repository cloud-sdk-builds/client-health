...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.997.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.997.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hvk/d/g9kK8lgk6wgc1CSbPn0JSIxr3amodX+4GC1P/vwx9WUlDdSE7U4asrH4dn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.997.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.997.0/index.min.mjs": "sha384-hvk/d/g9kK8lgk6wgc1CSbPn0JSIxr3amodX+4GC1P/vwx9WUlDdSE7U4asrH4dn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.997.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.337.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.337.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-a0nIC62uppcT0Lt1ODx4iXhdiG76pMR4ubzXsZEy11oJus4ilpmVudVIsS2TlKZt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.337.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.337.0/index.min.mjs": "sha384-a0nIC62uppcT0Lt1ODx4iXhdiG76pMR4ubzXsZEy11oJus4ilpmVudVIsS2TlKZt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.337.0/LICENSE
```

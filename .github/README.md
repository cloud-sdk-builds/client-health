...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.511.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.511.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dOijf5OhBCo5svKLFFUZEn6hu/AHMilfaQWXVvLlJxGz+VJTMiv9zE4u5dV2R3MC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.511.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.511.0/index.min.mjs": "sha384-dOijf5OhBCo5svKLFFUZEn6hu/AHMilfaQWXVvLlJxGz+VJTMiv9zE4u5dV2R3MC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.511.0/LICENSE
```

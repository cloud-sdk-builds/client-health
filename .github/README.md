...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.974.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.974.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M0f1+OMgMYtlhqo4B9dl3Ve4w8esf0S8a5Ww6mk0R5scn0bi01idxoon0dddTGta
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.974.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.974.0/index.min.mjs": "sha384-M0f1+OMgMYtlhqo4B9dl3Ve4w8esf0S8a5Ww6mk0R5scn0bi01idxoon0dddTGta"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.974.0/LICENSE
```

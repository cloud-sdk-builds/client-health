...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.812.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.812.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-midjqADNuVVTUe3JQ8y0gu2PGC5nrkb4p4J0E/M7V0gJoQZPH5yWuKPg9VepgIeq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.812.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.812.0/index.min.mjs": "sha384-midjqADNuVVTUe3JQ8y0gu2PGC5nrkb4p4J0E/M7V0gJoQZPH5yWuKPg9VepgIeq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.812.0/LICENSE
```

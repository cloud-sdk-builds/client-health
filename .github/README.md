...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.572.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.572.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CcyVD9LZAoyiY7xdvDxhbFQyVf+qcXuWsagu6mmd6ph5N3quj/y3IrFq4NsDSjDk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.572.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.572.0/index.min.mjs": "sha384-CcyVD9LZAoyiY7xdvDxhbFQyVf+qcXuWsagu6mmd6ph5N3quj/y3IrFq4NsDSjDk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.572.0/LICENSE
```

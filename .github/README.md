...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.319.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.319.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JJKeflIvT8avBfGoO7a/KeZo4gifjeLQUqz2V6L2Vzaxt2SHhg3QYXnYqAOuSHPf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.319.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.319.0/index.min.mjs": "sha384-JJKeflIvT8avBfGoO7a/KeZo4gifjeLQUqz2V6L2Vzaxt2SHhg3QYXnYqAOuSHPf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.319.0/LICENSE
```

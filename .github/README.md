...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.458.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.458.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QGZY1SS8tREV5bGMF4wTBDKQiNByFHmstL24c58NPCl2CaVRcLvwIn6nPD3FtoOD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.458.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.458.0/index.min.mjs": "sha384-QGZY1SS8tREV5bGMF4wTBDKQiNByFHmstL24c58NPCl2CaVRcLvwIn6nPD3FtoOD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.458.0/LICENSE
```

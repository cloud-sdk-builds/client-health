...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.631.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.631.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QhO6WcjMDpNIBHilazMmf0NQVGoZj+MvIHK5jcJkv+B/h+PI+0t5YUm8qG8CXUoU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.631.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.631.0/index.min.mjs": "sha384-QhO6WcjMDpNIBHilazMmf0NQVGoZj+MvIHK5jcJkv+B/h+PI+0t5YUm8qG8CXUoU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.631.0/LICENSE
```

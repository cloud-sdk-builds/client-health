...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.587.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.587.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uIaey2pEJ0xYhYo8m6d0e11Gwwf7CAz2JcXdDj9zhJfJVFYcSePrekBgcSPUux7S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.587.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.587.0/index.min.mjs": "sha384-uIaey2pEJ0xYhYo8m6d0e11Gwwf7CAz2JcXdDj9zhJfJVFYcSePrekBgcSPUux7S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.587.0/LICENSE
```

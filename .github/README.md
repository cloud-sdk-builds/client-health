...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.529.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.529.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-wJ4h60GC0fjzGJvbkVQCA7G9QCc1otbOaZrqmq/hgq/HOr9NA0PZP5uqgSF7OTfT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.529.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.529.1/index.min.mjs": "sha384-wJ4h60GC0fjzGJvbkVQCA7G9QCc1otbOaZrqmq/hgq/HOr9NA0PZP5uqgSF7OTfT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.529.1/LICENSE
```

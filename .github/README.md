...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.47.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.47.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-3W63ZHc0gdRCv4CkRn+gGq5OMneqwguke1hRqUfBeHmMz/y+Hw2rpTpq9opWz+8B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.47.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.47.1/index.min.mjs": "sha384-3W63ZHc0gdRCv4CkRn+gGq5OMneqwguke1hRqUfBeHmMz/y+Hw2rpTpq9opWz+8B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.47.1/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.817.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.817.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-E77H0ZS7xPDer4yxdYEdkdoKVdeaoZ56vUPFJrB6oktD1LwtWb5yDlsuqKWJvHjE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.817.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.817.0/index.min.mjs": "sha384-E77H0ZS7xPDer4yxdYEdkdoKVdeaoZ56vUPFJrB6oktD1LwtWb5yDlsuqKWJvHjE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.817.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.12.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.12.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-R7cXmd+m+BGyRmImA5Vx0uNDGNoAPG4WVtmwFv78soLrtwA+0Tbd6n0sh474Ob3N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.12.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.12.0/index.min.mjs": "sha384-R7cXmd+m+BGyRmImA5Vx0uNDGNoAPG4WVtmwFv78soLrtwA+0Tbd6n0sh474Ob3N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.12.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.296.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.296.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XQOeNQcCc8kzH9yYWLkxxBTjiBvalqjB85wIVMplMrNWPzid/fzkI57d5dUPP5uO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.296.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.296.0/index.min.mjs": "sha384-XQOeNQcCc8kzH9yYWLkxxBTjiBvalqjB85wIVMplMrNWPzid/fzkI57d5dUPP5uO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.296.0/LICENSE
```

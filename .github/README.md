...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.863.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.863.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pplvILi86tez4FNyEvMJkBSasuPHQI3FsuuxpXUDXOFP8DLpciEoDs+yREVmH31j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.863.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.863.0/index.min.mjs": "sha384-pplvILi86tez4FNyEvMJkBSasuPHQI3FsuuxpXUDXOFP8DLpciEoDs+yREVmH31j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.863.0/LICENSE
```

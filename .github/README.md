...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.105.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.105.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cVb6euJ9cPjMewxUl7moFjZF87EPYQ1akkCEdFF2bBJUrddFoUp4zBW3Hx7nXEZZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.105.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.105.0/index.min.mjs": "sha384-cVb6euJ9cPjMewxUl7moFjZF87EPYQ1akkCEdFF2bBJUrddFoUp4zBW3Hx7nXEZZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.105.0/LICENSE
```

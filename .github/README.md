...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.213.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.213.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UWOM0M+BnUv5ktS0HFKKqRd2v/3GfJ9bUDlj6X66EY17gOYksNspjKibcDxl3kRN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.213.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.213.0/index.min.mjs": "sha384-UWOM0M+BnUv5ktS0HFKKqRd2v/3GfJ9bUDlj6X66EY17gOYksNspjKibcDxl3kRN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.213.0/LICENSE
```

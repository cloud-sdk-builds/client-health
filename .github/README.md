...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.258.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.258.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lz3auf+x4WzLTbG5DZVMrKb4qruxnu+kFSGSBATnFS2YvJ/l2WSE6a3qic54s5WU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.258.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.258.0/index.min.mjs": "sha384-lz3auf+x4WzLTbG5DZVMrKb4qruxnu+kFSGSBATnFS2YvJ/l2WSE6a3qic54s5WU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.258.0/LICENSE
```

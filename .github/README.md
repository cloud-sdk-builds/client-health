...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.266.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.266.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zrRs9Amuzai0MOPnCImCIKWDrmXsd2viyh7QfI6xGcCFKP5Ez+7rLbnGPuDIb9um
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.266.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.266.0/index.min.mjs": "sha384-zrRs9Amuzai0MOPnCImCIKWDrmXsd2viyh7QfI6xGcCFKP5Ez+7rLbnGPuDIb9um"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.266.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.650.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.650.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TvUtxkrl055A5iMD+V/tQH9ixUgoe97KKi64+9RwmUWNIU/g/T9DqOL7AcJ9NVgx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.650.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.650.0/index.min.mjs": "sha384-TvUtxkrl055A5iMD+V/tQH9ixUgoe97KKi64+9RwmUWNIU/g/T9DqOL7AcJ9NVgx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.650.0/LICENSE
```

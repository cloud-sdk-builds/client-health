...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.921.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.921.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vhMKykKoma1S0zPECB/s1Pog+3fTz4d2/TJm6orqYRNFyT4EP6y/7VSecI3WPooz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.921.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.921.0/index.min.mjs": "sha384-vhMKykKoma1S0zPECB/s1Pog+3fTz4d2/TJm6orqYRNFyT4EP6y/7VSecI3WPooz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.921.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.919.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.919.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Pc/zZ4MQN0Qi1k5BenXguWW/MFTNrbYSP51k9m/79JwQ98cum1Wcu80OvA7QzOrF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.919.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.919.0/index.min.mjs": "sha384-Pc/zZ4MQN0Qi1k5BenXguWW/MFTNrbYSP51k9m/79JwQ98cum1Wcu80OvA7QzOrF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.919.0/LICENSE
```

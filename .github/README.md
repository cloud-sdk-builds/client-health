...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.197.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.197.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AWYvE5bqvD24sOB7f0NwCovvUx20yGr3doHesM6xRMf8VEQzfBIjcPA8pDsVQJoG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.197.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.197.0/index.min.mjs": "sha384-AWYvE5bqvD24sOB7f0NwCovvUx20yGr3doHesM6xRMf8VEQzfBIjcPA8pDsVQJoG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.197.0/LICENSE
```

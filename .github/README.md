...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.691.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.691.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-o5KLp0tSEJuIQ0/hMuwBFkIlT/TMgDhdjScHAcWgc5oyrMu05th5KMO/gRDUbjGH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.691.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.691.0/index.min.mjs": "sha384-o5KLp0tSEJuIQ0/hMuwBFkIlT/TMgDhdjScHAcWgc5oyrMu05th5KMO/gRDUbjGH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.691.0/LICENSE
```

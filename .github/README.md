...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.35.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.35.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-w9jgtv+OPEODS7TUVAcy/QhzRmZMZ0PB4n5eJ5I82tC4H4h+NfV0dItwE6sTwvNl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.35.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.35.0/index.min.mjs": "sha384-w9jgtv+OPEODS7TUVAcy/QhzRmZMZ0PB4n5eJ5I82tC4H4h+NfV0dItwE6sTwvNl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.35.0/LICENSE
```

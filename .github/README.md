...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.741.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.741.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-f49zMkeoGa/bW9IapsmPvoirMkeXB1ZOiShhRqdh6+fF2lit7VE2dbGM0tYt4zB8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.741.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.741.0/index.min.mjs": "sha384-f49zMkeoGa/bW9IapsmPvoirMkeXB1ZOiShhRqdh6+fF2lit7VE2dbGM0tYt4zB8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.741.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.666.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.666.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-y10wHRQ8XPWnhLDruBCbAci+OIK1QR1buZuJlxB0MZUEX+niSR1WRcZDpg0Rtevx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.666.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.666.0/index.min.mjs": "sha384-y10wHRQ8XPWnhLDruBCbAci+OIK1QR1buZuJlxB0MZUEX+niSR1WRcZDpg0Rtevx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.666.0/LICENSE
```

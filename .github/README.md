...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.645.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.645.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-42hMXSL682By8WgbBy8G6jXi/i7POtudvX9TnG43TZ8xN+IiH5fcMpSdNMC/qEWh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.645.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.645.0/index.min.mjs": "sha384-42hMXSL682By8WgbBy8G6jXi/i7POtudvX9TnG43TZ8xN+IiH5fcMpSdNMC/qEWh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.645.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.449.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.449.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HlCO3s6ORKPIHXEUUwCGY7FblooxXv1HIkV/YYd6NXNOP+wZCBmeEXtwkYJE4uGJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.449.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.449.0/index.min.mjs": "sha384-HlCO3s6ORKPIHXEUUwCGY7FblooxXv1HIkV/YYd6NXNOP+wZCBmeEXtwkYJE4uGJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.449.0/LICENSE
```

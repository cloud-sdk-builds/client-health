...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.629.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.629.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JjxfjLBbzC66MFBa+XoWeM1niWiFBDioDIXmfKSm3Gekm4xKfAB6wL9529jOWaji
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.629.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.629.0/index.min.mjs": "sha384-JjxfjLBbzC66MFBa+XoWeM1niWiFBDioDIXmfKSm3Gekm4xKfAB6wL9529jOWaji"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.629.0/LICENSE
```

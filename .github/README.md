...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.267.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.267.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oqDyV4QS1pixVmaMlrWmk036gFKPZvT6z/yQoN3Nt0i0JvSex7dOUGePKS1VT5tP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.267.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.267.0/index.min.mjs": "sha384-oqDyV4QS1pixVmaMlrWmk036gFKPZvT6z/yQoN3Nt0i0JvSex7dOUGePKS1VT5tP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.267.0/LICENSE
```

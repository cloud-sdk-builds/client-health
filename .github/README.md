...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.972.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.972.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/kUsiyN2a94kNjo31qtaeZY6BLoQ1hht+ZFQkxMkymUMOp/8LEcnPT1g5ElrVe8m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.972.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.972.0/index.min.mjs": "sha384-/kUsiyN2a94kNjo31qtaeZY6BLoQ1hht+ZFQkxMkymUMOp/8LEcnPT1g5ElrVe8m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.972.0/LICENSE
```

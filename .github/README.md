...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.816.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.816.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9bgqfxUw4XMf3a9J5HeUENISlzPH3iHjsV0B95kF2rxfYv2OTCdwQoCd3CTFitWo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.816.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.816.0/index.min.mjs": "sha384-9bgqfxUw4XMf3a9J5HeUENISlzPH3iHjsV0B95kF2rxfYv2OTCdwQoCd3CTFitWo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.816.0/LICENSE
```

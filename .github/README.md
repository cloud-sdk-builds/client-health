...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.231.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.231.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XBEEyvCtRC4dmSo8PMStbKJqirvIh521Q5qr3Kl6cCnWZlrSfbgpj7oSlDJbdKAl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.231.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.231.0/index.min.mjs": "sha384-XBEEyvCtRC4dmSo8PMStbKJqirvIh521Q5qr3Kl6cCnWZlrSfbgpj7oSlDJbdKAl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.231.0/LICENSE
```

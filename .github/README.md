...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.797.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.797.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oSfZsO3bEyjdGe0zbzURhjw5Awy7bHAtwhyHAxD/w3nD47CvY4AmEnApzG3joVTs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.797.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.797.0/index.min.mjs": "sha384-oSfZsO3bEyjdGe0zbzURhjw5Awy7bHAtwhyHAxD/w3nD47CvY4AmEnApzG3joVTs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.797.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.678.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.678.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m8S+T7vnQ7VL36VW3jfpDxTezcPJmP24Mdb/0Wkttyo5TUGDQX34RNeAlT6Uo9JN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.678.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.678.0/index.min.mjs": "sha384-m8S+T7vnQ7VL36VW3jfpDxTezcPJmP24Mdb/0Wkttyo5TUGDQX34RNeAlT6Uo9JN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.678.0/LICENSE
```

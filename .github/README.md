...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.332.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.332.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qnGHz3BbHc9dw6pT8Z2E7HGIQ2gmkSg6tsTSAbBdmzL+5r/IfdN8I8gy8Dx3zMAM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.332.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.332.0/index.min.mjs": "sha384-qnGHz3BbHc9dw6pT8Z2E7HGIQ2gmkSg6tsTSAbBdmzL+5r/IfdN8I8gy8Dx3zMAM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.332.0/LICENSE
```

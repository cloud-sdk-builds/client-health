...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.18.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.18.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ItdngrDwOGe/QFOx8rO8h8UBDksJO44RysroI++2vnt9LC3yqhWo6GrhEO8urTDx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.18.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.18.0/index.min.mjs": "sha384-ItdngrDwOGe/QFOx8rO8h8UBDksJO44RysroI++2vnt9LC3yqhWo6GrhEO8urTDx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.18.0/LICENSE
```

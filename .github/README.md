...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.825.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.825.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JA4ymUfYPCWOTsSGht39t1E12+XZ6QlyRHgilMWpDz2S7cg8Y6+Ue6rGBzsUIOjS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.825.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.825.0/index.min.mjs": "sha384-JA4ymUfYPCWOTsSGht39t1E12+XZ6QlyRHgilMWpDz2S7cg8Y6+Ue6rGBzsUIOjS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.825.0/LICENSE
```

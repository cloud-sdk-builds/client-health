...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.986.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.986.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9wBp4qwNmyqjG+InmPBJLjW7tuyYH1odTp9U4/C5qMQ0Kpgqts8/oTBkpJ+2UWVm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.986.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.986.0/index.min.mjs": "sha384-9wBp4qwNmyqjG+InmPBJLjW7tuyYH1odTp9U4/C5qMQ0Kpgqts8/oTBkpJ+2UWVm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.986.0/LICENSE
```

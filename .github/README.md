...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.798.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.798.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4fMccjO5XvYarbf+A6ETbvu/8ncn7KrTRdiPJqNI0r591hjNCkQnIhBkilaWyw+3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.798.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.798.0/index.min.mjs": "sha384-4fMccjO5XvYarbf+A6ETbvu/8ncn7KrTRdiPJqNI0r591hjNCkQnIhBkilaWyw+3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.798.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.984.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.984.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GYOd4VeY5EJw1WZnDt+qXiPU9/vys52UXBS6wud1CJ46sjZSJhoms6RQH+UjhaHQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.984.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.984.0/index.min.mjs": "sha384-GYOd4VeY5EJw1WZnDt+qXiPU9/vys52UXBS6wud1CJ46sjZSJhoms6RQH+UjhaHQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.984.0/LICENSE
```

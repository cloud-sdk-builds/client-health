...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.293.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.293.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bcCZytgsxXDS6zodeCCWta5rYEkW8ZXEd5lulN35Arg+Qt9oPTkkKno/P8Flm2YN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.293.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.293.0/index.min.mjs": "sha384-bcCZytgsxXDS6zodeCCWta5rYEkW8ZXEd5lulN35Arg+Qt9oPTkkKno/P8Flm2YN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.293.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.891.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.891.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vA5oCH1EfsoLu33UanCw9zOUgG+9HIqPgTTU7KFivuYpdlHuTRDypZMFnOiXwYel
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.891.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.891.0/index.min.mjs": "sha384-vA5oCH1EfsoLu33UanCw9zOUgG+9HIqPgTTU7KFivuYpdlHuTRDypZMFnOiXwYel"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.891.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.576.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.576.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m6uMXQTgviwVSXBkmD/waXStXZbiaxle5prTfuMf1sDVcYCeN8lS6nwol5p8YThZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.576.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.576.0/index.min.mjs": "sha384-m6uMXQTgviwVSXBkmD/waXStXZbiaxle5prTfuMf1sDVcYCeN8lS6nwol5p8YThZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.576.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.154.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.154.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8IFeK5BzdxbQWs+50DEILGdgQQdSjQWO9u+9m55Sf4jOyMbba2kdFmrX6JkQmJKK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.154.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.154.0/index.min.mjs": "sha384-8IFeK5BzdxbQWs+50DEILGdgQQdSjQWO9u+9m55Sf4jOyMbba2kdFmrX6JkQmJKK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.154.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.876.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.876.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Y9s3AA7eqsZDwSQnJZlnGahYIKC8nuVHbbLUpOKBy/3+XeWpfqJZbYtN+zLaU6zD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.876.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.876.0/index.min.mjs": "sha384-Y9s3AA7eqsZDwSQnJZlnGahYIKC8nuVHbbLUpOKBy/3+XeWpfqJZbYtN+zLaU6zD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.876.0/LICENSE
```

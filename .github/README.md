...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.379.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.379.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-uDK0AhOsksliZafd3j8jgSKJyNGtDOolOzy44MgtkLdWZ1Zy5S4VDC1QeQTMUI5w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.379.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.379.1/index.min.mjs": "sha384-uDK0AhOsksliZafd3j8jgSKJyNGtDOolOzy44MgtkLdWZ1Zy5S4VDC1QeQTMUI5w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.379.1/LICENSE
```

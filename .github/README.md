...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.888.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.888.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bjui/J8h4ef9fsOTnjAmZ0taCBOnjcuWIZjRiGWIRCmdYeFh3WJX7Ob8V/0HwdoP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.888.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.888.0/index.min.mjs": "sha384-bjui/J8h4ef9fsOTnjAmZ0taCBOnjcuWIZjRiGWIRCmdYeFh3WJX7Ob8V/0HwdoP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.888.0/LICENSE
```

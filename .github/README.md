...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1003.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1003.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lyVa+s58Zgcy0ilA2Kb3vgV9ovT4Mv+jcQ7dJM5JYxZMVjzYkSoGYmyyFIeppiVQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1003.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1003.0/index.min.mjs": "sha384-lyVa+s58Zgcy0ilA2Kb3vgV9ovT4Mv+jcQ7dJM5JYxZMVjzYkSoGYmyyFIeppiVQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1003.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.806.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.806.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r/wR4/xvVObzR3DWbt+WCyvmPKOARy7BO9KQP5SW+mlQIT3OJaffZiG+pmrTZTPj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.806.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.806.0/index.min.mjs": "sha384-r/wR4/xvVObzR3DWbt+WCyvmPKOARy7BO9KQP5SW+mlQIT3OJaffZiG+pmrTZTPj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.806.0/LICENSE
```

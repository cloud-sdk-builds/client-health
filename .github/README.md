...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.525.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.525.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3UCfM4nl1msHkmhpxc6WSJeLfBdTDx3lzOeuk19mcOsPVoJuJ/JM1fpiBZJWe/cQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.525.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.525.0/index.min.mjs": "sha384-3UCfM4nl1msHkmhpxc6WSJeLfBdTDx3lzOeuk19mcOsPVoJuJ/JM1fpiBZJWe/cQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.525.0/LICENSE
```

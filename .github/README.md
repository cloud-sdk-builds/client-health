...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.994.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.994.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Bmdr/Ob5JM6yWEjXVspTvl70BhR0fRpOSRGINrsogvDqxzdx8zE94JM9q53PvF4D
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.994.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.994.0/index.min.mjs": "sha384-Bmdr/Ob5JM6yWEjXVspTvl70BhR0fRpOSRGINrsogvDqxzdx8zE94JM9q53PvF4D"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.994.0/LICENSE
```

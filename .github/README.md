...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.385.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.385.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ph7KJC96d2NKQ90AHuCJpTZG3xaMokPtSktCAON577fEzdqd/17yOBcAyAXse2BW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.385.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.385.0/index.min.mjs": "sha384-Ph7KJC96d2NKQ90AHuCJpTZG3xaMokPtSktCAON577fEzdqd/17yOBcAyAXse2BW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.385.0/LICENSE
```

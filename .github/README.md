...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.926.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.926.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xmTM1gbIsRuA6oFPezoe5tFG9iorDMM/1GdAGZIK3wDA4qAkDzraRS7n5Vlsf6Fj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.926.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.926.0/index.min.mjs": "sha384-xmTM1gbIsRuA6oFPezoe5tFG9iorDMM/1GdAGZIK3wDA4qAkDzraRS7n5Vlsf6Fj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.926.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.598.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.598.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MwQbGTv2FEprp1Ey2OC5peEGtrl6MVx4lYKeOtDxz9IPsPftDROcOI1GyCpOr2NY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.598.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.598.0/index.min.mjs": "sha384-MwQbGTv2FEprp1Ey2OC5peEGtrl6MVx4lYKeOtDxz9IPsPftDROcOI1GyCpOr2NY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.598.0/LICENSE
```

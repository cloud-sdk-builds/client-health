...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.303.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.303.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4vk0U2kXZxFkBJOFi74/Wdpg5E9Taa3a7KbPZM9DyZjzsIbwopiCcn4TjrFC9qSe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.303.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.303.0/index.min.mjs": "sha384-4vk0U2kXZxFkBJOFi74/Wdpg5E9Taa3a7KbPZM9DyZjzsIbwopiCcn4TjrFC9qSe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.303.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.692.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.692.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hcX38+WxAwzzjNaMXUdDHmlgOAwGfwuYNc+xBHrNkwwTbKyFJ+hLlG6ltuIMw7Yn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.692.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.692.0/index.min.mjs": "sha384-hcX38+WxAwzzjNaMXUdDHmlgOAwGfwuYNc+xBHrNkwwTbKyFJ+hLlG6ltuIMw7Yn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.692.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.436.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.436.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x0KgmQvR425q3IFZ6HPbIUgUfFR0Kbi5iJANfsjpT1PwkRkghX8uxkuCGeEQ4oTE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.436.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.436.0/index.min.mjs": "sha384-x0KgmQvR425q3IFZ6HPbIUgUfFR0Kbi5iJANfsjpT1PwkRkghX8uxkuCGeEQ4oTE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.436.0/LICENSE
```

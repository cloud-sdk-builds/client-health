...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1030.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1030.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oJHwO9jyyITPD9XWK8HEUetTcVPyaNh7JuhdZnEe7ABQk2oq7mlOavQhwC8ZDOKB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1030.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1030.0/index.min.mjs": "sha384-oJHwO9jyyITPD9XWK8HEUetTcVPyaNh7JuhdZnEe7ABQk2oq7mlOavQhwC8ZDOKB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1030.0/LICENSE
```

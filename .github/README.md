...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1017.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1017.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KFS5gENVnXpXYWbxHU6OILlBE/74k5l7ubmqVtBzB5k3DCOEOn0n64DMOgaE38z3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1017.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1017.0/index.min.mjs": "sha384-KFS5gENVnXpXYWbxHU6OILlBE/74k5l7ubmqVtBzB5k3DCOEOn0n64DMOgaE38z3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1017.0/LICENSE
```

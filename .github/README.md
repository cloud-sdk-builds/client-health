...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.29.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.29.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jiIOAj9wePPSu4D98s+/4z/LLMZtUjlpVQYwUwwy9rRi64RmUWwsJf3+Xv9+s20e
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.29.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.29.0/index.min.mjs": "sha384-jiIOAj9wePPSu4D98s+/4z/LLMZtUjlpVQYwUwwy9rRi64RmUWwsJf3+Xv9+s20e"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.29.0/LICENSE
```

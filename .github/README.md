...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.632.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.632.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RmZGZsoEUEaZe6M1Odr832MGfZDvNrTmG+zisRfG/KX0PEHi3+3xT82l7ePVnAfU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.632.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.632.0/index.min.mjs": "sha384-RmZGZsoEUEaZe6M1Odr832MGfZDvNrTmG+zisRfG/KX0PEHi3+3xT82l7ePVnAfU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.632.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.477.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.477.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fDuE7hDdn9UQXw6k7ijk5Gz5WvQhI9zi3lR3Mx3wFDMjrfKro8GsGifJj615+iRZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.477.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.477.0/index.min.mjs": "sha384-fDuE7hDdn9UQXw6k7ijk5Gz5WvQhI9zi3lR3Mx3wFDMjrfKro8GsGifJj615+iRZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.477.0/LICENSE
```

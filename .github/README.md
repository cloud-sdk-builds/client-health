...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.687.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.687.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9wOdQtQX4343oNQzxG//iRFwF6+BYtaKnELXLH6DenzZyvZ5AbODuCuYEy4kSvSH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.687.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.687.0/index.min.mjs": "sha384-9wOdQtQX4343oNQzxG//iRFwF6+BYtaKnELXLH6DenzZyvZ5AbODuCuYEy4kSvSH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.687.0/LICENSE
```

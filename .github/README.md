...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.936.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.936.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zKWF1PhfyjtLYUhzmSmLzw6tLjgNNAkcnpevnGFMIr7L1Hb5FDo7L14Ukf7FkQ29
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.936.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.936.0/index.min.mjs": "sha384-zKWF1PhfyjtLYUhzmSmLzw6tLjgNNAkcnpevnGFMIr7L1Hb5FDo7L14Ukf7FkQ29"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.936.0/LICENSE
```

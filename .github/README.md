...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.5.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.5.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oS+6aBxiDr4R34zGA8OXRPjOiyrqjT5m1/Wj2lD37Wr3mEZBQYk3ZzXtMZhcYdd8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.5.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.5.0/index.min.mjs": "sha384-oS+6aBxiDr4R34zGA8OXRPjOiyrqjT5m1/Wj2lD37Wr3mEZBQYk3ZzXtMZhcYdd8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.5.0/LICENSE
```

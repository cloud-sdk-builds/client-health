...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.864.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.864.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eYke3m7ZDAzzPg1n9mg9KCOFjX+Z//M0CeGFVv3ERepsfatpllU60HSC75TomUCp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.864.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.864.0/index.min.mjs": "sha384-eYke3m7ZDAzzPg1n9mg9KCOFjX+Z//M0CeGFVv3ERepsfatpllU60HSC75TomUCp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.864.0/LICENSE
```

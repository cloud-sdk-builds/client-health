...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.226.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.226.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yeFTwUFXekenbv13OtC8hj/LtRnp5hOkoSRi9YK+qOWTGT7RKC9zHpwpJARbYaH3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.226.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.226.0/index.min.mjs": "sha384-yeFTwUFXekenbv13OtC8hj/LtRnp5hOkoSRi9YK+qOWTGT7RKC9zHpwpJARbYaH3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.226.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.533.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.533.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fLO+ZSUJks4vt3baJwNWQxtSUQGPrWg7mGTXtXJ1HfbFdCZ2TgJuEFvgUIWphqPI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.533.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.533.0/index.min.mjs": "sha384-fLO+ZSUJks4vt3baJwNWQxtSUQGPrWg7mGTXtXJ1HfbFdCZ2TgJuEFvgUIWphqPI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.533.0/LICENSE
```

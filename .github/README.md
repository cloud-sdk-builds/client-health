...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.954.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.954.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3APMwwuaW+9vOo7wijvm521kTNpL57cUURAygNIs23lGt28nx49KJ1Izk0LwAUpy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.954.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.954.0/index.min.mjs": "sha384-3APMwwuaW+9vOo7wijvm521kTNpL57cUURAygNIs23lGt28nx49KJ1Izk0LwAUpy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.954.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.723.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.723.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-14cctzJsj1sKv+6jUic1cVcbJoa/2vHY6GefK9encBGhoGqGH5HpGsAtkq0vfoch
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.723.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.723.0/index.min.mjs": "sha384-14cctzJsj1sKv+6jUic1cVcbJoa/2vHY6GefK9encBGhoGqGH5HpGsAtkq0vfoch"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.723.0/LICENSE
```

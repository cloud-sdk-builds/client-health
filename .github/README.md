...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.163.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.163.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bCqnSd9IR3LKqu/nLkuxqk1nMGT+iGnr/wQgjtJCozUmNS+O7Cl6aQHlTqkptmhj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.163.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.163.0/index.min.mjs": "sha384-bCqnSd9IR3LKqu/nLkuxqk1nMGT+iGnr/wQgjtJCozUmNS+O7Cl6aQHlTqkptmhj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.163.0/LICENSE
```

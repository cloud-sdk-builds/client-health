...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.160.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.160.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Dw3LzteMz9O6ZSc3qCr59WjLnsq4qXD6jd+DB/wjQ5KlXf0UE6OY2LmPrO+wyr1i
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.160.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.160.0/index.min.mjs": "sha384-Dw3LzteMz9O6ZSc3qCr59WjLnsq4qXD6jd+DB/wjQ5KlXf0UE6OY2LmPrO+wyr1i"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.160.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.45.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.45.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cnyWMKk+012v92WhAYEMoQC7bGBSbGnBHBhD2ud1sYJxuWUri/VqqpLBwFSRgSL8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.45.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.45.0/index.min.mjs": "sha384-cnyWMKk+012v92WhAYEMoQC7bGBSbGnBHBhD2ud1sYJxuWUri/VqqpLBwFSRgSL8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.45.0/LICENSE
```

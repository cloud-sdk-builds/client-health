...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.454.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.454.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k/J3DF/QRXeMzP+b3tSiR4JOPPWhR1hMBIW27byypnn/Pk84tSjwQbCs3mJeP5/s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.454.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.454.0/index.min.mjs": "sha384-k/J3DF/QRXeMzP+b3tSiR4JOPPWhR1hMBIW27byypnn/Pk84tSjwQbCs3mJeP5/s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.454.0/LICENSE
```

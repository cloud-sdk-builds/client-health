...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.256.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.256.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ksemoabo9RW0d9JVUYEFe4pTrTZbDcU1PD0sr/VtimaCkE6hIU0a6eRZJfmdY9+0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.256.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.256.0/index.min.mjs": "sha384-Ksemoabo9RW0d9JVUYEFe4pTrTZbDcU1PD0sr/VtimaCkE6hIU0a6eRZJfmdY9+0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.256.0/LICENSE
```

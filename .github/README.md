...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1014.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1014.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3oy+eBvpH+hDwvX9WpRtRVN8k3v4O9nc4P/RIE7B4TefAHYmaQ9F0EMkq1JSkVMC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1014.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1014.0/index.min.mjs": "sha384-3oy+eBvpH+hDwvX9WpRtRVN8k3v4O9nc4P/RIE7B4TefAHYmaQ9F0EMkq1JSkVMC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1014.0/LICENSE
```

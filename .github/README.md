...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.6.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.6.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-XzHxDZFxnlrE8066QiMYFXcdmoOMTsOci5Z7l0zPcJ8GDdRgnmZXJ2+ekApez80f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.6.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.6.1/index.min.mjs": "sha384-XzHxDZFxnlrE8066QiMYFXcdmoOMTsOci5Z7l0zPcJ8GDdRgnmZXJ2+ekApez80f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.6.1/LICENSE
```

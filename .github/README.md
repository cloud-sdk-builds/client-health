...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.410.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.410.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2h/7q4y8wIi12nqVlqc1DRn0pdEH2gRy/BNjNEjqIxIISDvJrlrGerBmisKFDPt2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.410.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.410.0/index.min.mjs": "sha384-2h/7q4y8wIi12nqVlqc1DRn0pdEH2gRy/BNjNEjqIxIISDvJrlrGerBmisKFDPt2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.410.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.730.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.730.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xoZxq1c3WWGCCMLyj9+yjNSDM46nfHnm1POsHRUolR4NCO/YC+2XBXZGSegMbIwS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.730.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.730.0/index.min.mjs": "sha384-xoZxq1c3WWGCCMLyj9+yjNSDM46nfHnm1POsHRUolR4NCO/YC+2XBXZGSegMbIwS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.730.0/LICENSE
```

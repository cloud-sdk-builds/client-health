...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.445.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.445.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cHOvJaJUoQqOXwyAcket2Nqp3K9ycNOl9rXmtdWIozz1sQbisvhkh7Alki6phxcl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.445.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.445.0/index.min.mjs": "sha384-cHOvJaJUoQqOXwyAcket2Nqp3K9ycNOl9rXmtdWIozz1sQbisvhkh7Alki6phxcl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.445.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.295.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.295.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3xHUswUN4w4mfR7TnmXzoaYMt9JeFSG9VQiRmBofttyHHEWIRFf85w5cbrOIT9yX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.295.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.295.0/index.min.mjs": "sha384-3xHUswUN4w4mfR7TnmXzoaYMt9JeFSG9VQiRmBofttyHHEWIRFf85w5cbrOIT9yX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.295.0/LICENSE
```

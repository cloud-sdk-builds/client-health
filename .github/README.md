...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1033.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1033.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RkDiNQhCBqTFzs8qvtwDy3J/xy2i9JenQUOnCdTkISRHqp5KM5BpY54yJJgjxncp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1033.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1033.0/index.min.mjs": "sha384-RkDiNQhCBqTFzs8qvtwDy3J/xy2i9JenQUOnCdTkISRHqp5KM5BpY54yJJgjxncp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1033.0/LICENSE
```

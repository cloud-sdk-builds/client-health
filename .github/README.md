...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.224.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.224.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EGyDMyfKYHbF7xpONlyvzLQZ5RNjOMtpS3DscoLt3s34mbd0EHzLB56cdjhCqA+L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.224.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.224.0/index.min.mjs": "sha384-EGyDMyfKYHbF7xpONlyvzLQZ5RNjOMtpS3DscoLt3s34mbd0EHzLB56cdjhCqA+L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.224.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.58.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.58.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sogfDZUGZokGO1bfDrQakeJtQlDzlfRX4r6yU5x8/qR/zFzbafhj4/nfgKnjWzKE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.58.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.58.0/index.min.mjs": "sha384-sogfDZUGZokGO1bfDrQakeJtQlDzlfRX4r6yU5x8/qR/zFzbafhj4/nfgKnjWzKE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.58.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.8.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.8.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MGaM9nIyvY4AofNKtmGwZ/RorFuA9fH+zCZAnKE0DECEnoO6bB+tHCFPxJoKtfnK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.8.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.8.0/index.min.mjs": "sha384-MGaM9nIyvY4AofNKtmGwZ/RorFuA9fH+zCZAnKE0DECEnoO6bB+tHCFPxJoKtfnK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.8.0/LICENSE
```

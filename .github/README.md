...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.503.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.503.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-DAt1YZIVS2ieVoiVHzTrDlxyxq8230DbVjU2v059ym9uuUL9u8jWolH4eWf4MMII
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.503.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.503.1/index.min.mjs": "sha384-DAt1YZIVS2ieVoiVHzTrDlxyxq8230DbVjU2v059ym9uuUL9u8jWolH4eWf4MMII"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.503.1/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.202.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.202.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2iXY4MYJobj038P0IWtKILfUr2Z8Ns/DGP7Q2ls6cNqSMC8xWPW7HwkSxkO+JI+q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.202.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.202.0/index.min.mjs": "sha384-2iXY4MYJobj038P0IWtKILfUr2Z8Ns/DGP7Q2ls6cNqSMC8xWPW7HwkSxkO+JI+q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.202.0/LICENSE
```

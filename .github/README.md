...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1036.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1036.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-B8eni2erkOxrP67RnAeUM0hASs28jeRKzLANbFDk605xDMHhufkIpAPNDmtbY9PS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1036.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1036.0/index.min.mjs": "sha384-B8eni2erkOxrP67RnAeUM0hASs28jeRKzLANbFDk605xDMHhufkIpAPNDmtbY9PS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1036.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.67.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.67.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-94B2LpKCivsCBHj88UMRho9Y11sR/9vSSwolLwxzX/4E0MKtyQEOwpAui4zHDVfN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.67.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.67.0/index.min.mjs": "sha384-94B2LpKCivsCBHj88UMRho9Y11sR/9vSSwolLwxzX/4E0MKtyQEOwpAui4zHDVfN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.67.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.6.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.6.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1+Sdz66C3w7gbVJR6C7yIwwwCyxl1HArlanHhE/DRhNaLcruzPSl2hyTwbY6bMEE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.6.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.6.0/index.min.mjs": "sha384-1+Sdz66C3w7gbVJR6C7yIwwwCyxl1HArlanHhE/DRhNaLcruzPSl2hyTwbY6bMEE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.6.0/LICENSE
```

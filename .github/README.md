...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.679.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.679.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qLoVrc8FD8i/tEXrgpeCxVDwMpQdjShcVtDV0mSV7+1NrIPJ/a8Go2BekKMzjSq0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.679.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.679.0/index.min.mjs": "sha384-qLoVrc8FD8i/tEXrgpeCxVDwMpQdjShcVtDV0mSV7+1NrIPJ/a8Go2BekKMzjSq0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.679.0/LICENSE
```

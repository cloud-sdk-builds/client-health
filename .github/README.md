...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.987.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.987.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-epDRTifTXNq+WT8pS+8mhmhZdXK8yZmZw10o3zh3tLhaI1EsGMEMch6gJGvQyyXR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.987.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.987.0/index.min.mjs": "sha384-epDRTifTXNq+WT8pS+8mhmhZdXK8yZmZw10o3zh3tLhaI1EsGMEMch6gJGvQyyXR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.987.0/LICENSE
```

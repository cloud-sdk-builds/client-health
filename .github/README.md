...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.37.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.37.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IgYa+c1acd4mTKpzO6fsDGVwPJ1j28EYE8+CWu76gDeUHsDMw4xHPfb5tc51uWln
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.37.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.37.0/index.min.mjs": "sha384-IgYa+c1acd4mTKpzO6fsDGVwPJ1j28EYE8+CWu76gDeUHsDMw4xHPfb5tc51uWln"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.37.0/LICENSE
```

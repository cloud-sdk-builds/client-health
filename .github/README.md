...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.2.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.2.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Wu+MM09EvoapSD0XllW9/EqCBZA5bvzGNl1gtNFt3sYxoya4qTfn2XPVhiSeVLtT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.2.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.2.0/index.min.mjs": "sha384-Wu+MM09EvoapSD0XllW9/EqCBZA5bvzGNl1gtNFt3sYxoya4qTfn2XPVhiSeVLtT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.2.0/LICENSE
```

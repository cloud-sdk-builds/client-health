...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.94.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.94.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kxiiJj7NerspW6E/s6UUG9j/qXYEo7G+kWxacAfJyDNRa9ylwni9nEspu5p2reQJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.94.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.94.0/index.min.mjs": "sha384-kxiiJj7NerspW6E/s6UUG9j/qXYEo7G+kWxacAfJyDNRa9ylwni9nEspu5p2reQJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.94.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.128.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.128.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7yIUdWM3redWBF6aeZL4BaVFqRE986bn5wqgI4JtT27fgC1dZkvNEdYuOdkIUGZG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.128.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.128.0/index.min.mjs": "sha384-7yIUdWM3redWBF6aeZL4BaVFqRE986bn5wqgI4JtT27fgC1dZkvNEdYuOdkIUGZG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.128.0/LICENSE
```

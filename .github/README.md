...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.835.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.835.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x61NOhXO1s0beaB38d6K0vLuoIAp8RaZREQQK28xM4gsXKAYFqJNW318YlCZuP72
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.835.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.835.0/index.min.mjs": "sha384-x61NOhXO1s0beaB38d6K0vLuoIAp8RaZREQQK28xM4gsXKAYFqJNW318YlCZuP72"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.835.0/LICENSE
```

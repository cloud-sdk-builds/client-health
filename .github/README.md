...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.872.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.872.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8l4n8ugAkM0zVQecTD35ehn1AwvUnIVPUZBizkZtz+gAXIt1ouBZnvIO9qe3lwqT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.872.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.872.0/index.min.mjs": "sha384-8l4n8ugAkM0zVQecTD35ehn1AwvUnIVPUZBizkZtz+gAXIt1ouBZnvIO9qe3lwqT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.872.0/LICENSE
```

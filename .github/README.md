...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.899.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.899.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Wbg7rzzNBfQT802fxYhT2eDaooUkhu+BAjtJwCC/iVeX/mykSR/B0mOJ9/Ry5H5F
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.899.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.899.0/index.min.mjs": "sha384-Wbg7rzzNBfQT802fxYhT2eDaooUkhu+BAjtJwCC/iVeX/mykSR/B0mOJ9/Ry5H5F"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.899.0/LICENSE
```

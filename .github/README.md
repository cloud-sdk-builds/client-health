...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.844.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.844.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tpACTAoxxaL0ppfkr16SwrI8/VriYC608NU6CCGHhuni+rcwRDde72rV73q8DGqs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.844.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.844.0/index.min.mjs": "sha384-tpACTAoxxaL0ppfkr16SwrI8/VriYC608NU6CCGHhuni+rcwRDde72rV73q8DGqs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.844.0/LICENSE
```

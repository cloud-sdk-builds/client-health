...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.651.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.651.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-EN5qYCi1AuFhUG0FHyH+/kq+L+duolx4xseeBkHsRSvu6qZaZHhpejVZs5hWDiBb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.651.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.651.1/index.min.mjs": "sha384-EN5qYCi1AuFhUG0FHyH+/kq+L+duolx4xseeBkHsRSvu6qZaZHhpejVZs5hWDiBb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.651.1/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1004.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1004.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jk3AqEnpicje5sY1A9+WEHDeBUMw+ipJGLwZcJSD88RFjqu0oxmm9yEg99RKYSJH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1004.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1004.0/index.min.mjs": "sha384-jk3AqEnpicje5sY1A9+WEHDeBUMw+ipJGLwZcJSD88RFjqu0oxmm9yEg99RKYSJH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1004.0/LICENSE
```

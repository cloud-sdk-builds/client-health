...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.777.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.777.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-g7dnp+bCaRYSafGl4yL+wvvee2NQFrb9fY7RsH/rQ/aYgMDIw2TpqoekTIWsZJdb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.777.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.777.0/index.min.mjs": "sha384-g7dnp+bCaRYSafGl4yL+wvvee2NQFrb9fY7RsH/rQ/aYgMDIw2TpqoekTIWsZJdb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.777.0/LICENSE
```

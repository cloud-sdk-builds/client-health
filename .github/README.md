...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.328.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.328.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d+1Sa1cEWjFdnqTAmvkjAPYg1rG6G3qATZzW2nViJjngyJq/s9VUMYx51nq6VDYT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.328.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.328.0/index.min.mjs": "sha384-d+1Sa1cEWjFdnqTAmvkjAPYg1rG6G3qATZzW2nViJjngyJq/s9VUMYx51nq6VDYT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.328.0/LICENSE
```

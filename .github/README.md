...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.312.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.312.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-INpOHHmD/bkpOO0GrEk0/kR8rleNiobW9GrTq39lK+unBW8ZBGPsXaNJbBkX6IO7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.312.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.312.0/index.min.mjs": "sha384-INpOHHmD/bkpOO0GrEk0/kR8rleNiobW9GrTq39lK+unBW8ZBGPsXaNJbBkX6IO7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.312.0/LICENSE
```

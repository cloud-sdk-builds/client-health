...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.848.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.848.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-65CwwT0zC26znVnJGqvtXFBwtKFfp3X8y8eyoaMy3cqh2B6jO9Clzadu8YOCm0f0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.848.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.848.0/index.min.mjs": "sha384-65CwwT0zC26znVnJGqvtXFBwtKFfp3X8y8eyoaMy3cqh2B6jO9Clzadu8YOCm0f0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.848.0/LICENSE
```

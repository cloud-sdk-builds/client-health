...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.503.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.503.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ok8CLqZ2sr0k7njRA25hOff7HLuaGsLAfaif4khxwcONB2X2YQdRvxXBZ/ZG8+ep
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.503.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.503.0/index.min.mjs": "sha384-Ok8CLqZ2sr0k7njRA25hOff7HLuaGsLAfaif4khxwcONB2X2YQdRvxXBZ/ZG8+ep"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.503.0/LICENSE
```

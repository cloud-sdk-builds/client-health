...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.749.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.749.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bZ3GIaWiIyQK0WRrnPTskacH6afswCy1E4HJNTDSu2Swb9ZpcRw+0tFLdza64L9J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.749.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.749.0/index.min.mjs": "sha384-bZ3GIaWiIyQK0WRrnPTskacH6afswCy1E4HJNTDSu2Swb9ZpcRw+0tFLdza64L9J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.749.0/LICENSE
```

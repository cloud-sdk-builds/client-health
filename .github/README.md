...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.810.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.810.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mtF2K79VBgtU4yDE47CvFxHCC/1dGrCMnM5vXCEdJ5Dnqszyr9YMynbmKrS2Db7o
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.810.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.810.0/index.min.mjs": "sha384-mtF2K79VBgtU4yDE47CvFxHCC/1dGrCMnM5vXCEdJ5Dnqszyr9YMynbmKrS2Db7o"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.810.0/LICENSE
```

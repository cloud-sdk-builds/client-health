...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.473.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.473.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7h3RGB4Y1I7UAteFS/TC1k8uKOGIJh/DmIoMW1TLOG3vBsIfEnyIGBbfHecJ7S3A
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.473.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.473.0/index.min.mjs": "sha384-7h3RGB4Y1I7UAteFS/TC1k8uKOGIJh/DmIoMW1TLOG3vBsIfEnyIGBbfHecJ7S3A"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.473.0/LICENSE
```

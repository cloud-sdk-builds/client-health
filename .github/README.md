...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.658.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.658.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mBR1Ef84/8qAUVqqtFgo7mI3QyW6Di8djTQt7M/wfjHFjwGHqLiV2YPfYAhDWxNy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.658.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.658.0/index.min.mjs": "sha384-mBR1Ef84/8qAUVqqtFgo7mI3QyW6Di8djTQt7M/wfjHFjwGHqLiV2YPfYAhDWxNy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.658.0/LICENSE
```

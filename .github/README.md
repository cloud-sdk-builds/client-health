...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.49.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.49.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Iz70l17rgR6N6ZQy7P6xk5ECyquMpkxlEe9Y+rIVVwyuyBnDNYfxY9Ph8YTIuzVu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.49.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.49.0/index.min.mjs": "sha384-Iz70l17rgR6N6ZQy7P6xk5ECyquMpkxlEe9Y+rIVVwyuyBnDNYfxY9Ph8YTIuzVu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.49.0/LICENSE
```

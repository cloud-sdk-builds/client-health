...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.405.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.405.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Uk1b4NBPkO+KYAE5M/wiQFFhcOLaJQIspy7GTU+aeitXrlcUHkf83S/wQ+jftmLZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.405.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.405.0/index.min.mjs": "sha384-Uk1b4NBPkO+KYAE5M/wiQFFhcOLaJQIspy7GTU+aeitXrlcUHkf83S/wQ+jftmLZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.405.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.895.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.895.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rfbjOAbaa2guRG/zYwLWIk+aPB6Z2GZbZ6sR1AWdCz2eCDEAI3nXab83ONW+X3Ra
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.895.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.895.0/index.min.mjs": "sha384-rfbjOAbaa2guRG/zYwLWIk+aPB6Z2GZbZ6sR1AWdCz2eCDEAI3nXab83ONW+X3Ra"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.895.0/LICENSE
```

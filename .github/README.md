...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.451.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.451.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GIgjqSOnZBp9IJjlR+J6YB1VKnz/R5nmEK8U7+PQiobKw45nFSbFLi3Z61SAczRE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.451.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.451.0/index.min.mjs": "sha384-GIgjqSOnZBp9IJjlR+J6YB1VKnz/R5nmEK8U7+PQiobKw45nFSbFLi3Z61SAczRE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.451.0/LICENSE
```

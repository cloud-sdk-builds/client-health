...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.433.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.433.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c0AKN9De9REUdWmbwW7WLH2U5Goxtxh9OdBEph0vYeHRokLxX6NaeADWp9ywEWC1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.433.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.433.0/index.min.mjs": "sha384-c0AKN9De9REUdWmbwW7WLH2U5Goxtxh9OdBEph0vYeHRokLxX6NaeADWp9ywEWC1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.433.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.82.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.82.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N86fHtEb9f864YIOpJKGMhSr7aAfgiBjqjkuMgtmFh77KdwofNQITv+aYDLePiZa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.82.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.82.0/index.min.mjs": "sha384-N86fHtEb9f864YIOpJKGMhSr7aAfgiBjqjkuMgtmFh77KdwofNQITv+aYDLePiZa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.82.0/LICENSE
```

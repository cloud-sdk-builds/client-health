...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.623.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.623.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1puiiCUBT4vjjSgyA5/wkWTPgPGu4MkkFWHzYqj6wz7mlxjbUB7AjbXONY7AGvJc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.623.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.623.0/index.min.mjs": "sha384-1puiiCUBT4vjjSgyA5/wkWTPgPGu4MkkFWHzYqj6wz7mlxjbUB7AjbXONY7AGvJc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.623.0/LICENSE
```

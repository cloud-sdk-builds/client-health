...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.358.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.358.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PAtCIi0V4zWU2c204eL45V7AbGSIPM45yG5cl2Ncvp+7LriCDCbOwjS9fuBlerfd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.358.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.358.0/index.min.mjs": "sha384-PAtCIi0V4zWU2c204eL45V7AbGSIPM45yG5cl2Ncvp+7LriCDCbOwjS9fuBlerfd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.358.0/LICENSE
```

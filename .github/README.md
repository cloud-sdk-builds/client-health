...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.563.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.563.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iZeKBWULJVucFTndd2RpseQ6VVBAZYo/n+GcrSaf8SbP/4ubjwtKI5ELeX+a06y5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.563.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.563.0/index.min.mjs": "sha384-iZeKBWULJVucFTndd2RpseQ6VVBAZYo/n+GcrSaf8SbP/4ubjwtKI5ELeX+a06y5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.563.0/LICENSE
```

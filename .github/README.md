...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.481.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.481.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OonvSE70XTNLB8NYYytPPzQiN/xjMbr+26YGBmtXSJH195yDUH/ckiReyJ40WN7N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.481.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.481.0/index.min.mjs": "sha384-OonvSE70XTNLB8NYYytPPzQiN/xjMbr+26YGBmtXSJH195yDUH/ckiReyJ40WN7N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.481.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.7.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.7.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8/mtALh/3UvkzslZrexl0WWRDFiLsxXOXLNAT/7GNB5NVB5GOPCH97rB8/ej3Ttl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.7.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.7.0/index.min.mjs": "sha384-8/mtALh/3UvkzslZrexl0WWRDFiLsxXOXLNAT/7GNB5NVB5GOPCH97rB8/ej3Ttl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.7.0/LICENSE
```

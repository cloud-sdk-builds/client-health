...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.54.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.54.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-YVquinvfTglSKq1KLhu5DepvMtBw4CjwfqU3XBVW9lPihdcSCwaCdJi9jG8QqE3L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.54.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.54.1/index.min.mjs": "sha384-YVquinvfTglSKq1KLhu5DepvMtBw4CjwfqU3XBVW9lPihdcSCwaCdJi9jG8QqE3L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.54.1/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.27.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.27.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eBkVx7fEPAjyQ0t8l7A4tDwg83NNSRRtPUH0Z/cR/ryel6tzoq7eEmNIwN5PB495
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.27.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.27.0/index.min.mjs": "sha384-eBkVx7fEPAjyQ0t8l7A4tDwg83NNSRRtPUH0Z/cR/ryel6tzoq7eEmNIwN5PB495"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.27.0/LICENSE
```

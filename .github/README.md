...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.298.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.298.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vq/yy+RQ1OpZ57WjMJzSpKg4OvlB8ebzUfj80ZjxHsl9swpbd/6Qqjm+PRupz+FQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.298.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.298.0/index.min.mjs": "sha384-vq/yy+RQ1OpZ57WjMJzSpKg4OvlB8ebzUfj80ZjxHsl9swpbd/6Qqjm+PRupz+FQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.298.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.830.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.830.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Gly1Wy8rm7WodeYNImPoxskQiURMGBxO37rbfvMLGnYuunakjVWdzq2j2RiIXs6Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.830.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.830.0/index.min.mjs": "sha384-Gly1Wy8rm7WodeYNImPoxskQiURMGBxO37rbfvMLGnYuunakjVWdzq2j2RiIXs6Z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.830.0/LICENSE
```

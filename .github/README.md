...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1035.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1035.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7BIJ9ZolBi91P5gFiDO9uko0wy1WAnJfKIwUlkZHwqs5ZrQyn+N/RTxFNOCnIWub
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1035.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1035.0/index.min.mjs": "sha384-7BIJ9ZolBi91P5gFiDO9uko0wy1WAnJfKIwUlkZHwqs5ZrQyn+N/RTxFNOCnIWub"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1035.0/LICENSE
```

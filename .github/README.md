...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.911.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.911.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hYmwr9bYpHrGV8U+5UCvGoEon79J7k8UPEicgRSF34yZ5B1KZbCVu6FWlMGBsYjY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.911.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.911.0/index.min.mjs": "sha384-hYmwr9bYpHrGV8U+5UCvGoEon79J7k8UPEicgRSF34yZ5B1KZbCVu6FWlMGBsYjY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.911.0/LICENSE
```

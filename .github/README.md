...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1007.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1007.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rZCkha2sXmR4vetd6a374vVJqB0dOZPPsNAx/iaANzGh/9kRIzfEgyV602avqn3x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1007.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1007.0/index.min.mjs": "sha384-rZCkha2sXmR4vetd6a374vVJqB0dOZPPsNAx/iaANzGh/9kRIzfEgyV602avqn3x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1007.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.218.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.218.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0hfbbOM55K3NYeHDI9uYk377zYws8AYlq+DJK9AKfAu6g+3IyjC6Ws7+BX4onuxg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.218.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.218.0/index.min.mjs": "sha384-0hfbbOM55K3NYeHDI9uYk377zYws8AYlq+DJK9AKfAu6g+3IyjC6Ws7+BX4onuxg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.218.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.992.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.992.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JzN8aYf+ee5wJk2trRSt9jZ3zqGduq0qSJjKGUZQP9wxUljuQL0BjR4WlPWocb/h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.992.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.992.0/index.min.mjs": "sha384-JzN8aYf+ee5wJk2trRSt9jZ3zqGduq0qSJjKGUZQP9wxUljuQL0BjR4WlPWocb/h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.992.0/LICENSE
```

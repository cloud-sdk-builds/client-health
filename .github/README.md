...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.53.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.53.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+jRGj6m6Sz/30hyk3aj4237rD8JwGzaYm5wjRXPWaV8rMYTza6i0MRTbSjvLx+2W
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.53.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.53.0/index.min.mjs": "sha384-+jRGj6m6Sz/30hyk3aj4237rD8JwGzaYm5wjRXPWaV8rMYTza6i0MRTbSjvLx+2W"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.53.0/LICENSE
```

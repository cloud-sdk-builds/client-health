...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.968.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.968.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JYCGiX7U2s/hYUvfqpmCjjrUOr3VOiAq1eNuZGRESB9pG32plNH56xHzlgVCahM2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.968.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.968.0/index.min.mjs": "sha384-JYCGiX7U2s/hYUvfqpmCjjrUOr3VOiAq1eNuZGRESB9pG32plNH56xHzlgVCahM2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.968.0/LICENSE
```

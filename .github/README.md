...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.855.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.855.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fpreVKJ99QXP5hv7B5UL+/m9cQ5Gs4548yAyqVY70OiPdXVD1GXvYSafv63JEGYL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.855.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.855.0/index.min.mjs": "sha384-fpreVKJ99QXP5hv7B5UL+/m9cQ5Gs4548yAyqVY70OiPdXVD1GXvYSafv63JEGYL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.855.0/LICENSE
```

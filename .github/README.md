...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.321.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.321.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-mC5FuFG9599SJ4GKK574cNdkryiheeYeLBucYxd+6TmOYI+PlJpxayqx12q352+o
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.321.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.321.1/index.min.mjs": "sha384-mC5FuFG9599SJ4GKK574cNdkryiheeYeLBucYxd+6TmOYI+PlJpxayqx12q352+o"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.321.1/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1006.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1006.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e6AYZyCMmUktTE5YnRo/7UIRt5lX6Ewo6u3kCZ8pXDtq6emsLmhf5mUeo64BEDDS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1006.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1006.0/index.min.mjs": "sha384-e6AYZyCMmUktTE5YnRo/7UIRt5lX6Ewo6u3kCZ8pXDtq6emsLmhf5mUeo64BEDDS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1006.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.569.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.569.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uuDwliNvIekvq1YqQXWteUU3z0eur+1ffqjBuI2F6yAxkvV8/U0I9r8UTMGDw7Qt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.569.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.569.0/index.min.mjs": "sha384-uuDwliNvIekvq1YqQXWteUU3z0eur+1ffqjBuI2F6yAxkvV8/U0I9r8UTMGDw7Qt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.569.0/LICENSE
```

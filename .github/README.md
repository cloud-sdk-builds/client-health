...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1016.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1016.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xqJmpO8wtYrDcyU+oKbucmTSsOKNEM4Z6Z55VPYDjPbFWiplgCzry/f4ytnv9ciX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1016.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1016.0/index.min.mjs": "sha384-xqJmpO8wtYrDcyU+oKbucmTSsOKNEM4Z6Z55VPYDjPbFWiplgCzry/f4ytnv9ciX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1016.0/LICENSE
```

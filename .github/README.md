...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.882.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.882.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HUoyUlxaxLIuTdhbBS9sYJGo75eyG15zVHsGM1MO0EJjcZX17k6amDa2Vpzpc2sv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.882.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.882.0/index.min.mjs": "sha384-HUoyUlxaxLIuTdhbBS9sYJGo75eyG15zVHsGM1MO0EJjcZX17k6amDa2Vpzpc2sv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.882.0/LICENSE
```

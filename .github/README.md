...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.726.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.726.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Va20xVAviFvAr0mQ4XlUB55lNCdzKhawHBBcSa5Pnsvg88DnLQZfe8Lgm06yOYSP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.726.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.726.0/index.min.mjs": "sha384-Va20xVAviFvAr0mQ4XlUB55lNCdzKhawHBBcSa5Pnsvg88DnLQZfe8Lgm06yOYSP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.726.0/LICENSE
```

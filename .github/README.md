...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.460.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.460.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9wrDYhxzG8Xpk1XPEtbbdKgdeahTlVgCydOKswmPXoEhZ51BQLfa2CNe2suSFGe6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.460.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.460.0/index.min.mjs": "sha384-9wrDYhxzG8Xpk1XPEtbbdKgdeahTlVgCydOKswmPXoEhZ51BQLfa2CNe2suSFGe6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.460.0/LICENSE
```

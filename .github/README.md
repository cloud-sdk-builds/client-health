...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.354.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.354.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-G6r0Bvbqwc2Jd6Lrvdn22Dn0/pX80SWwdBJ4Q3dnNpNGPNMXbs5wQ0gyZXVt/nLi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.354.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.354.0/index.min.mjs": "sha384-G6r0Bvbqwc2Jd6Lrvdn22Dn0/pX80SWwdBJ4Q3dnNpNGPNMXbs5wQ0gyZXVt/nLi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.354.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.826.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.826.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cT6O2A4m3V3E/Pkema7AAU4fb0qcV9QVYgRp7quD3IDZW+jJX5rFUgI/s/gRKiNT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.826.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.826.0/index.min.mjs": "sha384-cT6O2A4m3V3E/Pkema7AAU4fb0qcV9QVYgRp7quD3IDZW+jJX5rFUgI/s/gRKiNT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.826.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.235.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.235.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1hXqePiM/Taf/nMFzdOnbW9ylqda2MSWbUo4Pw6uZOBcjwv1NMC0uts5COPJOG5N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.235.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.235.0/index.min.mjs": "sha384-1hXqePiM/Taf/nMFzdOnbW9ylqda2MSWbUo4Pw6uZOBcjwv1NMC0uts5COPJOG5N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.235.0/LICENSE
```

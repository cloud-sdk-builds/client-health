...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.635.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.635.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-POAV6KJRiQXN9Adec3lRX+H8WnC9CLOBn2Pdek0ClaWGCykD3K1/fH4VoPSIUDSM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.635.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.635.0/index.min.mjs": "sha384-POAV6KJRiQXN9Adec3lRX+H8WnC9CLOBn2Pdek0ClaWGCykD3K1/fH4VoPSIUDSM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.635.0/LICENSE
```

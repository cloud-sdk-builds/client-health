...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.22.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.22.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0aooKgkbMRvcy1nZESU8cS0RiWJOfhuhczujbqp4SJilzNibOGMiGHFtZQKHktfd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.22.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.22.0/index.min.mjs": "sha384-0aooKgkbMRvcy1nZESU8cS0RiWJOfhuhczujbqp4SJilzNibOGMiGHFtZQKHktfd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.22.0/LICENSE
```

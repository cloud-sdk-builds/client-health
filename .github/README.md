...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.502.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.502.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CIRTNtitp/soGIh2/ZWXKqdTiix9XZxSGRrgIefg3SQ8Fb5qn7e+XoTyYmevkRl9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.502.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.502.0/index.min.mjs": "sha384-CIRTNtitp/soGIh2/ZWXKqdTiix9XZxSGRrgIefg3SQ8Fb5qn7e+XoTyYmevkRl9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.502.0/LICENSE
```

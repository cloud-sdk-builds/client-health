...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.194.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.194.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0GjJsw6VtJVc0ESsG6cm5nIhIUHXn0xHU8FnwPBia4JBAVo+PA/nz2TXWYj0FAwD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.194.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.194.0/index.min.mjs": "sha384-0GjJsw6VtJVc0ESsG6cm5nIhIUHXn0xHU8FnwPBia4JBAVo+PA/nz2TXWYj0FAwD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.194.0/LICENSE
```

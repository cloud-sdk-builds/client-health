...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.210.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.210.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4dN+5ZMwM4jexSZk+Jp3rqCqcQkH0CVfknrkK1YPCLVWH9jRQVO7LcF+lkL+GVbY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.210.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.210.0/index.min.mjs": "sha384-4dN+5ZMwM4jexSZk+Jp3rqCqcQkH0CVfknrkK1YPCLVWH9jRQVO7LcF+lkL+GVbY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.210.0/LICENSE
```

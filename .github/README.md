...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.540.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.540.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mcv4YdbdLiTyCi9UaYbmX9xKk57c2+zaUVpv21fl0DNjb8zJqGyOQU56weyN+83E
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.540.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.540.0/index.min.mjs": "sha384-mcv4YdbdLiTyCi9UaYbmX9xKk57c2+zaUVpv21fl0DNjb8zJqGyOQU56weyN+83E"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.540.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.211.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.211.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NT5BTRmLevI7VW+CK9nfUZvPM12fxVj82N1PS1I7Legbco7lilq/uPo+wIrU2lgx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.211.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.211.0/index.min.mjs": "sha384-NT5BTRmLevI7VW+CK9nfUZvPM12fxVj82N1PS1I7Legbco7lilq/uPo+wIrU2lgx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.211.0/LICENSE
```

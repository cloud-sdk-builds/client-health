...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.47.2).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.47.2/index.min.mjs
```

SRI SHA Hash

```text
sha384-9RMMcURlr0IQWKLd2H/Bj/HNVQqaLkl6E99TpiLuDhitpDfyS6YY330H8n7Hby5E
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.47.2/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.47.2/index.min.mjs": "sha384-9RMMcURlr0IQWKLd2H/Bj/HNVQqaLkl6E99TpiLuDhitpDfyS6YY330H8n7Hby5E"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.47.2/LICENSE
```

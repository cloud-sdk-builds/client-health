...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.360.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.360.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tYk3Ghg/FNMMytBNHX17JcBD+3CT9xhsp6Ubocz5+dGP71viFV/6YQyZdWl5lJE2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.360.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.360.0/index.min.mjs": "sha384-tYk3Ghg/FNMMytBNHX17JcBD+3CT9xhsp6Ubocz5+dGP71viFV/6YQyZdWl5lJE2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.360.0/LICENSE
```

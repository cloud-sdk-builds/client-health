...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.985.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.985.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XSGl9/DAhi/8MwZYLKdJx4G0CY5WCstxW8MmafjaJAoKD9e7DNyGRIt3l10YyO2t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.985.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.985.0/index.min.mjs": "sha384-XSGl9/DAhi/8MwZYLKdJx4G0CY5WCstxW8MmafjaJAoKD9e7DNyGRIt3l10YyO2t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.985.0/LICENSE
```

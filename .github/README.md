...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.893.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.893.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IbBcBZBY6niTiSZfT35QbpMwf1Dxtai32LVMs3WamrbRX8hB4ePW1RG+l3GMIJnP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.893.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.893.0/index.min.mjs": "sha384-IbBcBZBY6niTiSZfT35QbpMwf1Dxtai32LVMs3WamrbRX8hB4ePW1RG+l3GMIJnP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.893.0/LICENSE
```

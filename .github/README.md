...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.429.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.429.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FLT1QNWz41gIR97lIri9pzqC4OEpMgsKEQvoS06TLH49qiRD9J41AVHBhxfvhqlY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.429.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.429.0/index.min.mjs": "sha384-FLT1QNWz41gIR97lIri9pzqC4OEpMgsKEQvoS06TLH49qiRD9J41AVHBhxfvhqlY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.429.0/LICENSE
```

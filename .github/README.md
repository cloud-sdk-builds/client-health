...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.87.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.87.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ogPb4UPOPWVnMGt6ly0infrlTmZPt65i3LfA+4Iu53VMMzo0cmgjO01kI6pCBPPd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.87.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.87.0/index.min.mjs": "sha384-ogPb4UPOPWVnMGt6ly0infrlTmZPt65i3LfA+4Iu53VMMzo0cmgjO01kI6pCBPPd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.87.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.0.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.0.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JjPBN//4Ifx02OeaxGaVGmmZBqgubMcB+3xuywHAyKSiIFgy8yxC/ZMc0+eXoGjR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.0.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.0.0/index.min.mjs": "sha384-JjPBN//4Ifx02OeaxGaVGmmZBqgubMcB+3xuywHAyKSiIFgy8yxC/ZMc0+eXoGjR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.0.0/LICENSE
```

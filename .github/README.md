...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.901.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.901.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sqamCcG6cO8eAQ0sDqDZdmRI1H2JQdBzx3DlACwiMBMwWW5kW5Wnp3NPoUxyBlAW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.901.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.901.0/index.min.mjs": "sha384-sqamCcG6cO8eAQ0sDqDZdmRI1H2JQdBzx3DlACwiMBMwWW5kW5Wnp3NPoUxyBlAW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.901.0/LICENSE
```

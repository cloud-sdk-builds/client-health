...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.76.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.76.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MqtZmLw9YmyP1FMg0+/ylzOMj3/ZkGuW3h0W1gynC0e+dFPEQuqE9vOXi43rg2V0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.76.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.76.0/index.min.mjs": "sha384-MqtZmLw9YmyP1FMg0+/ylzOMj3/ZkGuW3h0W1gynC0e+dFPEQuqE9vOXi43rg2V0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.76.0/LICENSE
```

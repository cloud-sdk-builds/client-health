...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.577.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.577.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V6KOiiAjVJEGrUFRTOR1nvWRu/56BXMoQX9OCecOzGOvqy1KZrvDqHlUN3m9YuQs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.577.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.577.0/index.min.mjs": "sha384-V6KOiiAjVJEGrUFRTOR1nvWRu/56BXMoQX9OCecOzGOvqy1KZrvDqHlUN3m9YuQs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.577.0/LICENSE
```

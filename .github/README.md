...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.712.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.712.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XZfx7iAaE3qdj92OFcDhkljk3GAgxtdhTj/NDQmCeqCtU8wfGeHomRGtG16sv1T3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.712.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.712.0/index.min.mjs": "sha384-XZfx7iAaE3qdj92OFcDhkljk3GAgxtdhTj/NDQmCeqCtU8wfGeHomRGtG16sv1T3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.712.0/LICENSE
```

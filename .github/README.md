...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.431.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.431.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Rhi2vkzRr+kHXx7vEYjQFBnpBEmJXscpMZiWIr6lN9nMs6kITbEIudNY4w8K9b9A
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.431.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.431.0/index.min.mjs": "sha384-Rhi2vkzRr+kHXx7vEYjQFBnpBEmJXscpMZiWIr6lN9nMs6kITbEIudNY4w8K9b9A"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.431.0/LICENSE
```

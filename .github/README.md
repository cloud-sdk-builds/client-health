...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.289.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.289.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rPUFazFcvB8IkBxK7yVErbGKgFJyRJ1pMKpJJy3wwrCAuoNyasL4nx2tOOVTEEGe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.289.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.289.0/index.min.mjs": "sha384-rPUFazFcvB8IkBxK7yVErbGKgFJyRJ1pMKpJJy3wwrCAuoNyasL4nx2tOOVTEEGe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.289.0/LICENSE
```

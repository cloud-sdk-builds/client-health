...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.946.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.946.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XkrlmR8/e9bBu5/feLCqbcR6gP2R/488eUpm6NsVP9eRYU8pqmxaXSGHyHtuthEz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.946.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.946.0/index.min.mjs": "sha384-XkrlmR8/e9bBu5/feLCqbcR6gP2R/488eUpm6NsVP9eRYU8pqmxaXSGHyHtuthEz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.946.0/LICENSE
```

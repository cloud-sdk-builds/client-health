...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.808.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.808.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3+vhuB9Yk0w2F3olxpm5Mb672anli8AGmRKZqiAvHqXQrZLoxjk56e9Wo5psO1Ze
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.808.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.808.0/index.min.mjs": "sha384-3+vhuB9Yk0w2F3olxpm5Mb672anli8AGmRKZqiAvHqXQrZLoxjk56e9Wo5psO1Ze"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.808.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.535.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.535.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CKHN54PxKQsunwQ0FVw/wv1SOPGZ+aMMS0vtE8LuyBp+yr2cwD5jhxykXX8BIR/k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.535.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.535.0/index.min.mjs": "sha384-CKHN54PxKQsunwQ0FVw/wv1SOPGZ+aMMS0vtE8LuyBp+yr2cwD5jhxykXX8BIR/k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.535.0/LICENSE
```

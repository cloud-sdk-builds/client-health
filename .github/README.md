...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.130.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.130.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u5bqu69yGKqIx5IP+oSM63/4fC0RJAIfWLsU+8Pq6Wfio+z9Ve/IQSj+OtUJyi2b
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.130.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.130.0/index.min.mjs": "sha384-u5bqu69yGKqIx5IP+oSM63/4fC0RJAIfWLsU+8Pq6Wfio+z9Ve/IQSj+OtUJyi2b"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.130.0/LICENSE
```

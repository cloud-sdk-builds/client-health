...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.32.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.32.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nZjFYAL/h/sUMe+hcMDmtCaddfi2s+9XpHHz7fyCspH8ryrLbM9NImG2o9uGXDtp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.32.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.32.0/index.min.mjs": "sha384-nZjFYAL/h/sUMe+hcMDmtCaddfi2s+9XpHHz7fyCspH8ryrLbM9NImG2o9uGXDtp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.32.0/LICENSE
```

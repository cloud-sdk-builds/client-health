...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.204.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.204.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0Li0WZd+AyjaT5yPvVjEVRBW++pEgKgLaVeBE+KX+LPQKjiXDvAd70oz0SojABlY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.204.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.204.0/index.min.mjs": "sha384-0Li0WZd+AyjaT5yPvVjEVRBW++pEgKgLaVeBE+KX+LPQKjiXDvAd70oz0SojABlY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.204.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.554.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.554.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZjbuzdlSlko9Y3mIg3yabNfDbebQcLjSJzr65eIi/grUZwCBl4LECcx6UydyvrLg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.554.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.554.0/index.min.mjs": "sha384-ZjbuzdlSlko9Y3mIg3yabNfDbebQcLjSJzr65eIi/grUZwCBl4LECcx6UydyvrLg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.554.0/LICENSE
```

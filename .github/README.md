...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.180.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.180.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UKHwmcAzT0zP7yIAC/d1OGbB83k1UEqJuZkIT+l0OBSXUc7VFCdptAVpvAZ6syUW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.180.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.180.0/index.min.mjs": "sha384-UKHwmcAzT0zP7yIAC/d1OGbB83k1UEqJuZkIT+l0OBSXUc7VFCdptAVpvAZ6syUW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.180.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.421.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.421.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Qb2T5dJdJ0GedFHfAEqEMe59iisNgp35fQI3L/fW/MA8u9464RJY7UVepVnN+8h0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.421.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.421.0/index.min.mjs": "sha384-Qb2T5dJdJ0GedFHfAEqEMe59iisNgp35fQI3L/fW/MA8u9464RJY7UVepVnN+8h0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.421.0/LICENSE
```

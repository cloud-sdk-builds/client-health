...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.845.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.845.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-E81T6Au1yxIyrAhOgfr/8nVqO/D4QdgWaQuCPKoPdEu+3rCj9FI5cu7/gKPqERnc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.845.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.845.0/index.min.mjs": "sha384-E81T6Au1yxIyrAhOgfr/8nVqO/D4QdgWaQuCPKoPdEu+3rCj9FI5cu7/gKPqERnc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.845.0/LICENSE
```

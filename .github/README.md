...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.894.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.894.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AqweF9F/U2F4nakES5i/3SrODIiP6vtbh7f2sw7Z2LtfzyDNySUL8Cj9D/2Ti3Mw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.894.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.894.0/index.min.mjs": "sha384-AqweF9F/U2F4nakES5i/3SrODIiP6vtbh7f2sw7Z2LtfzyDNySUL8Cj9D/2Ti3Mw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.894.0/LICENSE
```

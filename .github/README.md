...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.315.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.315.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4T/LZJGH2BRfiF1pBgtv1XgTArEEq0I9ZbP8AMzIkYXp9p8J0S568byeOD+PZFaX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.315.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.315.0/index.min.mjs": "sha384-4T/LZJGH2BRfiF1pBgtv1XgTArEEq0I9ZbP8AMzIkYXp9p8J0S568byeOD+PZFaX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.315.0/LICENSE
```

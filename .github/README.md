...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.165.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.165.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MJTCuPra827f1oceuhFMroKKqHJSiIC7k8x5apwHrWD+Q8ZAos+tdwCNBNNrvB1D
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.165.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.165.0/index.min.mjs": "sha384-MJTCuPra827f1oceuhFMroKKqHJSiIC7k8x5apwHrWD+Q8ZAos+tdwCNBNNrvB1D"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.165.0/LICENSE
```

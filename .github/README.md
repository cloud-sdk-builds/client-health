...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.450.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.450.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EHTYuLzKXVgMSG2nXrX/2Q93s50VUHX5eoEqOH+JvAp2RKfPS9R7NZGkAfg/PQgM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.450.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.450.0/index.min.mjs": "sha384-EHTYuLzKXVgMSG2nXrX/2Q93s50VUHX5eoEqOH+JvAp2RKfPS9R7NZGkAfg/PQgM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.450.0/LICENSE
```

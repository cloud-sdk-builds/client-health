...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.929.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.929.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1AelsJ3cK/+489wYskzMHYvAHYYxUWoq045/wW1TJr83i+JzLtW8dKFSxVlFEfPr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.929.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.929.0/index.min.mjs": "sha384-1AelsJ3cK/+489wYskzMHYvAHYYxUWoq045/wW1TJr83i+JzLtW8dKFSxVlFEfPr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.929.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.183.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.183.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-al/qwYB5UmLqm6MIJFw2GWLE1UDCNpxMXhu/+dkEU3LGhUHeTQQtnjJcJmuzt6wU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.183.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.183.0/index.min.mjs": "sha384-al/qwYB5UmLqm6MIJFw2GWLE1UDCNpxMXhu/+dkEU3LGhUHeTQQtnjJcJmuzt6wU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.183.0/LICENSE
```

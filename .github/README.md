...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.252.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.252.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Xyj8ZdF2FlgW4fpCbCzMCn2VJ7PxswRPLjRgMGwllB29wgbJSPJbfe1+KWSdoFxQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.252.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.252.0/index.min.mjs": "sha384-Xyj8ZdF2FlgW4fpCbCzMCn2VJ7PxswRPLjRgMGwllB29wgbJSPJbfe1+KWSdoFxQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.252.0/LICENSE
```

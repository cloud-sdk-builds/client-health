...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.969.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.969.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kYQ4j26a7x9CPyZA7NcfCg7jAGJ1HNBho5DNKl5xMfGED41VIOGIIvjh/KN1eDcl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.969.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.969.0/index.min.mjs": "sha384-kYQ4j26a7x9CPyZA7NcfCg7jAGJ1HNBho5DNKl5xMfGED41VIOGIIvjh/KN1eDcl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.969.0/LICENSE
```

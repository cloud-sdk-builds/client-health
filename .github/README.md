...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.4.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.4.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fp3ZKnrqVgHVgfKe091yR+ZsE9ed6b18GEC0QFJyD5oQYdRXwYSaxHncLO8zKaO8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.4.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.4.0/index.min.mjs": "sha384-fp3ZKnrqVgHVgfKe091yR+ZsE9ed6b18GEC0QFJyD5oQYdRXwYSaxHncLO8zKaO8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.4.0/LICENSE
```

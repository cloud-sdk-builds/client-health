...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.14.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.14.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yrh5BCR144xaAlBZYJ5iDNyrGGiMzeL+CKAo39jPyVRrGruAaaYQyNrzNg4nt6FE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.14.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.14.0/index.min.mjs": "sha384-yrh5BCR144xaAlBZYJ5iDNyrGGiMzeL+CKAo39jPyVRrGruAaaYQyNrzNg4nt6FE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.14.0/LICENSE
```

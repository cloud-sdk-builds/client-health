...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.168.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.168.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1v6RxJ5UgpldezPv4ZjKi8yP6Gpltl4g54MmklXDq699mbijoNQSsGTxCG1tMd0z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.168.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.168.0/index.min.mjs": "sha384-1v6RxJ5UgpldezPv4ZjKi8yP6Gpltl4g54MmklXDq699mbijoNQSsGTxCG1tMd0z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.168.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.693.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.693.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8OXxXeBvVJcJX2rHcjfzvAT1IiqSs07t/I/S7pFiavtJ0rZ7wk4UjM/s/5GHBs31
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.693.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.693.0/index.min.mjs": "sha384-8OXxXeBvVJcJX2rHcjfzvAT1IiqSs07t/I/S7pFiavtJ0rZ7wk4UjM/s/5GHBs31"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.693.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.395.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.395.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NwmWTwOcXRHhfgVjN1jaCnvpvScsigJ5EaInnuLdT9TwfzAK1LmE1fOHoR0uVuiU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.395.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.395.0/index.min.mjs": "sha384-NwmWTwOcXRHhfgVjN1jaCnvpvScsigJ5EaInnuLdT9TwfzAK1LmE1fOHoR0uVuiU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.395.0/LICENSE
```

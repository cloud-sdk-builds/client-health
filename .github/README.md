...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.142.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.142.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FWPObXf8CJv/2ItLwzv1UhnLfyrmtaG1Tg6KIeHD4cfSet8SpWEMZayF9Pyh+Aan
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.142.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.142.0/index.min.mjs": "sha384-FWPObXf8CJv/2ItLwzv1UhnLfyrmtaG1Tg6KIeHD4cfSet8SpWEMZayF9Pyh+Aan"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.142.0/LICENSE
```

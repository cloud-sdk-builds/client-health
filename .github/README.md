...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.750.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.750.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-f3NEsTkA1k1txRKfy3MJgGglbPFEXnQenbIpU6jpwVIqrFuZDpk8GBwWYrYSq+nc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.750.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.750.0/index.min.mjs": "sha384-f3NEsTkA1k1txRKfy3MJgGglbPFEXnQenbIpU6jpwVIqrFuZDpk8GBwWYrYSq+nc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.750.0/LICENSE
```

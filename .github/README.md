...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1032.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1032.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-G+v0b0NHPAcCQ09TqNJCeTcUthpsCGNYGIZx/YDEOs14gkkp5hRsqGNw0QOOHMH/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1032.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1032.0/index.min.mjs": "sha384-G+v0b0NHPAcCQ09TqNJCeTcUthpsCGNYGIZx/YDEOs14gkkp5hRsqGNw0QOOHMH/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1032.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.667.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.667.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pZ/Mow+5fnMzIrfv2Ro971cgF3BVVRgV1nYASHK2oY8CFKvmDZtc1rpQz4gEBuFr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.667.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.667.0/index.min.mjs": "sha384-pZ/Mow+5fnMzIrfv2Ro971cgF3BVVRgV1nYASHK2oY8CFKvmDZtc1rpQz4gEBuFr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.667.0/LICENSE
```

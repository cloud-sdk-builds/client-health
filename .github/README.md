...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.662.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.662.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7kVdeZSPm5k7/ZVgdc/vUDc0TFYiPTXcsIGVjVrKSx7E7/9TCn3GiuPPpEB2G14p
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.662.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.662.0/index.min.mjs": "sha384-7kVdeZSPm5k7/ZVgdc/vUDc0TFYiPTXcsIGVjVrKSx7E7/9TCn3GiuPPpEB2G14p"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.662.0/LICENSE
```

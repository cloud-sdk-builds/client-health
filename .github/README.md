...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.8.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.8.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-pDS7QDd52PramIEZTVbWXaalMVMFRkPYoksgncgVnXs12qh53GOLPEtY1jZyN7HN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.8.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.8.1/index.min.mjs": "sha384-pDS7QDd52PramIEZTVbWXaalMVMFRkPYoksgncgVnXs12qh53GOLPEtY1jZyN7HN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.8.1/LICENSE
```

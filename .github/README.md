...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.828.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.828.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5jxg6q3m6ptwCJx98eZLFWtWxXkwN0Xf0qA+09XSuTtkf9ri1jY/+VeXNbgyek6c
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.828.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.828.0/index.min.mjs": "sha384-5jxg6q3m6ptwCJx98eZLFWtWxXkwN0Xf0qA+09XSuTtkf9ri1jY/+VeXNbgyek6c"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.828.0/LICENSE
```

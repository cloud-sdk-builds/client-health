...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1019.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1019.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OsSFPEPdZT7Intwv73A/FYGyTUJ845RwtcFQ8r5MVZivfzLGkccWjqy/9C2uX1bz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1019.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1019.0/index.min.mjs": "sha384-OsSFPEPdZT7Intwv73A/FYGyTUJ845RwtcFQ8r5MVZivfzLGkccWjqy/9C2uX1bz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1019.0/LICENSE
```

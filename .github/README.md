...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.264.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.264.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EGQFEkNFtPdxvSnDTvs4I+Jh3UTla+gugLZ36374B/K+9JXJL00Ufoyh0xxNWtWO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.264.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.264.0/index.min.mjs": "sha384-EGQFEkNFtPdxvSnDTvs4I+Jh3UTla+gugLZ36374B/K+9JXJL00Ufoyh0xxNWtWO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.264.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.428.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.428.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SSmuvxW2FEV280fXvbxFcG3Kg5yxu9qJL+V9AbA9l0Ea46YwqBfxJ6SGVwOlVBhb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.428.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.428.0/index.min.mjs": "sha384-SSmuvxW2FEV280fXvbxFcG3Kg5yxu9qJL+V9AbA9l0Ea46YwqBfxJ6SGVwOlVBhb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.428.0/LICENSE
```

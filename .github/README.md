...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.418.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.418.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k9M34KbahM3IgUR95WkNNWd+GCdb/LaiiWNPT/OiWDNZOU67zA/Jl1Wc1AlIJfnB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.418.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.418.0/index.min.mjs": "sha384-k9M34KbahM3IgUR95WkNNWd+GCdb/LaiiWNPT/OiWDNZOU67zA/Jl1Wc1AlIJfnB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.418.0/LICENSE
```

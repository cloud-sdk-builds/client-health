...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.352.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.352.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3NFDp/VTfh0JD0tXf+2b4wrnhkdhiIN8o1H0gK3P4oVkuT61OnXn0iktkh1Aq5a8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.352.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.352.0/index.min.mjs": "sha384-3NFDp/VTfh0JD0tXf+2b4wrnhkdhiIN8o1H0gK3P4oVkuT61OnXn0iktkh1Aq5a8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.352.0/LICENSE
```

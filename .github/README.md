...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.362.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.362.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qdikYI2YtgST1BMg45NqjXAegbfoVMCG8xMBxLEZYHm46vVQ7yoPIJdbimqyYLpI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.362.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.362.0/index.min.mjs": "sha384-qdikYI2YtgST1BMg45NqjXAegbfoVMCG8xMBxLEZYHm46vVQ7yoPIJdbimqyYLpI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.362.0/LICENSE
```

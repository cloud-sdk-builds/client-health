...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.743.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.743.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7WU1d+TQtuVL1hfG6h31KJcwAxASzQnJ+5PUNw6f06FkM5oBMtFYjx5i1UkSga0D
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.743.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.743.0/index.min.mjs": "sha384-7WU1d+TQtuVL1hfG6h31KJcwAxASzQnJ+5PUNw6f06FkM5oBMtFYjx5i1UkSga0D"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.743.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.965.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.965.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kIQIX2DhRR8H+H6cjlpMrXwzAYOYa7DO0I4B0/GZehGUFqkFSbPRXHTgmT0XMjEF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.965.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.965.0/index.min.mjs": "sha384-kIQIX2DhRR8H+H6cjlpMrXwzAYOYa7DO0I4B0/GZehGUFqkFSbPRXHTgmT0XMjEF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.965.0/LICENSE
```

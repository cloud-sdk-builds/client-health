...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.338.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.338.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e7FcLwIKwTYqKC49dsuG6iZ+OW0ZcKfX8RIeNxkal7B7kRvNMwyZfM3f7R5hAVla
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.338.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.338.0/index.min.mjs": "sha384-e7FcLwIKwTYqKC49dsuG6iZ+OW0ZcKfX8RIeNxkal7B7kRvNMwyZfM3f7R5hAVla"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.338.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.353.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.353.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Rbw5ZEeIRxcD8eIO+0ESv7z9kUmFpMhXyfCP3v10j5o30yJ0NvA/n+/mpyiaam7o
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.353.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.353.0/index.min.mjs": "sha384-Rbw5ZEeIRxcD8eIO+0ESv7z9kUmFpMhXyfCP3v10j5o30yJ0NvA/n+/mpyiaam7o"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.353.0/LICENSE
```

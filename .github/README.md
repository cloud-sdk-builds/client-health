...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.917.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.917.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+RAjLi/+4b5yDCOnxZ9xanQbcKu0gPEeQBf/B3MW/3a5at0qUWRNGADMXA8rwq2c
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.917.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.917.0/index.min.mjs": "sha384-+RAjLi/+4b5yDCOnxZ9xanQbcKu0gPEeQBf/B3MW/3a5at0qUWRNGADMXA8rwq2c"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.917.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.309.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.309.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rCxB53BLgYLoYUNIbxEmK95/sbQHUSer6AIRfo0svFFO1OlYyG4FuMsO0rcyjO8k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.309.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.309.0/index.min.mjs": "sha384-rCxB53BLgYLoYUNIbxEmK95/sbQHUSer6AIRfo0svFFO1OlYyG4FuMsO0rcyjO8k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.309.0/LICENSE
```

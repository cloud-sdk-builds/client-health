...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.914.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.914.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LBboqXd0kyaIL88FYrG8ts+J38O2h3A/YDV9zb+GQsxBlPq0uy3gT2y2qoYWfQ6v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.914.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.914.0/index.min.mjs": "sha384-LBboqXd0kyaIL88FYrG8ts+J38O2h3A/YDV9zb+GQsxBlPq0uy3gT2y2qoYWfQ6v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.914.0/LICENSE
```

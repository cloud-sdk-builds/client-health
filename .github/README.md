...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.425.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.425.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Wd7b0I4yVP26UZxqHOt3VB10+ct81k//V92r+FmPE5OfpLiiLtVBbxNzrutCCN7r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.425.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.425.0/index.min.mjs": "sha384-Wd7b0I4yVP26UZxqHOt3VB10+ct81k//V92r+FmPE5OfpLiiLtVBbxNzrutCCN7r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.425.0/LICENSE
```

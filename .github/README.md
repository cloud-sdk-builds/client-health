...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.299.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.299.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9MPjjjmnYLuwB4QLRaLpkg1U59u2ULrOA+UDNI+2NTRcmIMO72um6/YD1PM7nl6J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.299.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.299.0/index.min.mjs": "sha384-9MPjjjmnYLuwB4QLRaLpkg1U59u2ULrOA+UDNI+2NTRcmIMO72um6/YD1PM7nl6J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.299.0/LICENSE
```

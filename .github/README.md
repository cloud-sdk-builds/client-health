...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.118.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.118.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-8MmCzfDayDB43y6QRYZVk+umnp7S/eGqrZUMJSLzPFFupwVoJRinBRH2HWE4ia/Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.118.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.118.1/index.min.mjs": "sha384-8MmCzfDayDB43y6QRYZVk+umnp7S/eGqrZUMJSLzPFFupwVoJRinBRH2HWE4ia/Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.118.1/LICENSE
```

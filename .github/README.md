...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.118.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.118.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8lW+QBQdDq4dHisytbdMGh50Wn1g5VbNwUZh2pDOEfaX9BrHouHA3jXKN6J8fTdP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.118.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.118.0/index.min.mjs": "sha384-8lW+QBQdDq4dHisytbdMGh50Wn1g5VbNwUZh2pDOEfaX9BrHouHA3jXKN6J8fTdP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.118.0/LICENSE
```

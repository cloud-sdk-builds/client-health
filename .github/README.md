...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.437.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.437.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GI+emgGB5UkurvNcbOATSAww5P+hzMrEnOutryx/mSe3pT0gAOgo/nqIVnId3ikH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.437.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.437.0/index.min.mjs": "sha384-GI+emgGB5UkurvNcbOATSAww5P+hzMrEnOutryx/mSe3pT0gAOgo/nqIVnId3ikH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.437.0/LICENSE
```

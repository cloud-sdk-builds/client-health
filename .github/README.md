...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.170.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.170.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UFIAE1NjdpdyK4+wXLSvI3RdTl/OeF+hdmOxdLmy4Im+1ApKPG0oCBCMdFJYlrY/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.170.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.170.0/index.min.mjs": "sha384-UFIAE1NjdpdyK4+wXLSvI3RdTl/OeF+hdmOxdLmy4Im+1ApKPG0oCBCMdFJYlrY/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.170.0/LICENSE
```

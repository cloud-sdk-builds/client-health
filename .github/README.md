...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.772.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.772.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-J9dM6/oURn0b8qTNkwGLTh2yGJhjHopXPsckSF6rb5J7jL2CIitfEacNO4mCatF6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.772.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.772.0/index.min.mjs": "sha384-J9dM6/oURn0b8qTNkwGLTh2yGJhjHopXPsckSF6rb5J7jL2CIitfEacNO4mCatF6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.772.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.20.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.20.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-T3wDeb5qUG/mdoWJCPRjEQoeXSXG4iWj7CnDhRtLXrFy/5oUxbRcmYPcws3IR3+w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.20.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.20.0/index.min.mjs": "sha384-T3wDeb5qUG/mdoWJCPRjEQoeXSXG4iWj7CnDhRtLXrFy/5oUxbRcmYPcws3IR3+w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.20.0/LICENSE
```

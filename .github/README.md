...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.504.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.504.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3DmTPlu6vfV6BI1AvfK/Xfq4z0mU7t1nELAD3ffX9WNqaQB2zTstMDmlppWu/xmy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.504.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.504.0/index.min.mjs": "sha384-3DmTPlu6vfV6BI1AvfK/Xfq4z0mU7t1nELAD3ffX9WNqaQB2zTstMDmlppWu/xmy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.504.0/LICENSE
```

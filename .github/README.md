...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.79.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.79.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4vr1wxWuZ3DsFEnyG28wxFkjT8majmvzOC00euO6SnRlfoncf2mi55/owmTgZru9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.79.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.79.0/index.min.mjs": "sha384-4vr1wxWuZ3DsFEnyG28wxFkjT8majmvzOC00euO6SnRlfoncf2mi55/owmTgZru9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.79.0/LICENSE
```

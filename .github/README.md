...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.181.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.181.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nOan6Fa4xuiB12r6fwz1Hz/a8+udqZNfV9ME50p7iIbQypnmAYxNL0adx630yC/N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.181.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.181.0/index.min.mjs": "sha384-nOan6Fa4xuiB12r6fwz1Hz/a8+udqZNfV9ME50p7iIbQypnmAYxNL0adx630yC/N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.181.0/LICENSE
```

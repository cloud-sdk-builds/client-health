...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.995.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.995.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+2hny5IxRiiWUMvP98cBpvBAAE3tFGDLkccaXOBQP0SC63QXDsu3o+r/Z6IMnj+C
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.995.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.995.0/index.min.mjs": "sha384-+2hny5IxRiiWUMvP98cBpvBAAE3tFGDLkccaXOBQP0SC63QXDsu3o+r/Z6IMnj+C"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.995.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.514.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.514.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A6csBSnaTk1mIchSF6LMke2QzZ/oSIn2oESyJ8AQM7VCgACkEcsQ8k6eSNTgDqHz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.514.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.514.0/index.min.mjs": "sha384-A6csBSnaTk1mIchSF6LMke2QzZ/oSIn2oESyJ8AQM7VCgACkEcsQ8k6eSNTgDqHz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.514.0/LICENSE
```

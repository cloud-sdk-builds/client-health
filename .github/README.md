...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.378.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.378.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BTosSPTFjUq57fBblmWqPyZKOmGHuu+rexa89YQ+7o/UquFm4s+TkYmG2W6px2pb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.378.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.378.0/index.min.mjs": "sha384-BTosSPTFjUq57fBblmWqPyZKOmGHuu+rexa89YQ+7o/UquFm4s+TkYmG2W6px2pb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.378.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.523.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.523.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sclqYGr/y+YHLhqA/DJnTkKmCZ/gf797ggo6LXeTkvQLHIZs/c9G3QoyDwNN3qib
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.523.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.523.0/index.min.mjs": "sha384-sclqYGr/y+YHLhqA/DJnTkKmCZ/gf797ggo6LXeTkvQLHIZs/c9G3QoyDwNN3qib"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.523.0/LICENSE
```

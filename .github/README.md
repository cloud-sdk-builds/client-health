...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.34.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.34.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kp7ePk88+UW0T1tWWA/KUTBBKzU9ph3tJL1LmFxEKxoNsFuAmnADGjaE9naXeW9v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.34.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.34.0/index.min.mjs": "sha384-kp7ePk88+UW0T1tWWA/KUTBBKzU9ph3tJL1LmFxEKxoNsFuAmnADGjaE9naXeW9v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.34.0/LICENSE
```

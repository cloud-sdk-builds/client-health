...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.11.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.11.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cNejTMw5mSWSshp1cWMACmz3DrizvGNGv0GDreWLJmAwFylb51rbaEGJCGJ0lTTv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.11.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.11.0/index.min.mjs": "sha384-cNejTMw5mSWSshp1cWMACmz3DrizvGNGv0GDreWLJmAwFylb51rbaEGJCGJ0lTTv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.11.0/LICENSE
```

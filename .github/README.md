...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.933.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.933.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jDC40rz2dFQopdV/ZlJH9grO3DLgQ8zF9dDblQCEE8c/aVYa7hqp2MAltJb+hag/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.933.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.933.0/index.min.mjs": "sha384-jDC40rz2dFQopdV/ZlJH9grO3DLgQ8zF9dDblQCEE8c/aVYa7hqp2MAltJb+hag/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.933.0/LICENSE
```

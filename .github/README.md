...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.369.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.369.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XmdkIRym1lMnNo7fN/2/FYpsW61xW8mX6+BzDZ24XAL57UWJnka1jaOEGg8oI8E8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.369.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.369.0/index.min.mjs": "sha384-XmdkIRym1lMnNo7fN/2/FYpsW61xW8mX6+BzDZ24XAL57UWJnka1jaOEGg8oI8E8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.369.0/LICENSE
```

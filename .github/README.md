...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.13.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.13.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-Gmeug5e0h6UssS1SpfFhLMn+luMfguuC5kR+Fyf0b5vY5GhDEvpYZrOjfnk4QriQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.13.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.13.1/index.min.mjs": "sha384-Gmeug5e0h6UssS1SpfFhLMn+luMfguuC5kR+Fyf0b5vY5GhDEvpYZrOjfnk4QriQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.13.1/LICENSE
```

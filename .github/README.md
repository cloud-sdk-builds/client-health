...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.23.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.23.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-f4PExhluQHpZkeDrneBKLcvh0Zs8jhegdf5zS9vcSULUhZMcut/z8Hc16GhH57PW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.23.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.23.0/index.min.mjs": "sha384-f4PExhluQHpZkeDrneBKLcvh0Zs8jhegdf5zS9vcSULUhZMcut/z8Hc16GhH57PW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.23.0/LICENSE
```

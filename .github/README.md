...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.738.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.738.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tFMpKTUqSqajR8p2MK1itnNTTo8VrjTDqSbR/VO6mOVR8q4IXLXsfoaVM7cA7W7j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.738.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.738.0/index.min.mjs": "sha384-tFMpKTUqSqajR8p2MK1itnNTTo8VrjTDqSbR/VO6mOVR8q4IXLXsfoaVM7cA7W7j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.738.0/LICENSE
```

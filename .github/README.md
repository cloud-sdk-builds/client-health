...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.344.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.344.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O2kotn5qi8vuoxz2VBOeiWVy2xjTjeRZmc9DMZZhAFT2DmKSLB9ZsY0kGXqKWIn0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.344.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.344.0/index.min.mjs": "sha384-O2kotn5qi8vuoxz2VBOeiWVy2xjTjeRZmc9DMZZhAFT2DmKSLB9ZsY0kGXqKWIn0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.344.0/LICENSE
```

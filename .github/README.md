...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.72.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.72.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ocnD+1NysGyWw0nDQBSMxmEFT5Og4pqmKC74hYaGPMVv2Lyg60kZyQk7wSbo5jcC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.72.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.72.0/index.min.mjs": "sha384-ocnD+1NysGyWw0nDQBSMxmEFT5Og4pqmKC74hYaGPMVv2Lyg60kZyQk7wSbo5jcC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.72.0/LICENSE
```

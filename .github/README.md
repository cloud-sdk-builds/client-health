...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.758.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.758.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-b2GFg2WKCYLoDGiMFaUaV3gNvwG5pTrvosA8v+FHf/NYpWeW4VYPawxxM46SkUVW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.758.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.758.0/index.min.mjs": "sha384-b2GFg2WKCYLoDGiMFaUaV3gNvwG5pTrvosA8v+FHf/NYpWeW4VYPawxxM46SkUVW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.758.0/LICENSE
```

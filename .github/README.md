...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.196.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.196.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mF/AOX/C4uRoAGh40/3rAiM42kNhp6bqi5ontFsVv8fbAlZs/MCdvG7AXuJlmRqG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.196.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.196.0/index.min.mjs": "sha384-mF/AOX/C4uRoAGh40/3rAiM42kNhp6bqi5ontFsVv8fbAlZs/MCdvG7AXuJlmRqG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.196.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.948.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.948.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wAc2+R8tk8hbCGoujNM2RC3CSNMR94oyBlaWa8hJL5jlHTZslkJkZ5CD775e4FaG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.948.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.948.0/index.min.mjs": "sha384-wAc2+R8tk8hbCGoujNM2RC3CSNMR94oyBlaWa8hJL5jlHTZslkJkZ5CD775e4FaG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.948.0/LICENSE
```

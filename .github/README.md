...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.970.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.970.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dfwO7VeR/xzhR9UNRf/qkX7GUoAdR6A19Eph8BUF8ZPnHcS8B2ncfWio5wVZQLYe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.970.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.970.0/index.min.mjs": "sha384-dfwO7VeR/xzhR9UNRf/qkX7GUoAdR6A19Eph8BUF8ZPnHcS8B2ncfWio5wVZQLYe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.970.0/LICENSE
```

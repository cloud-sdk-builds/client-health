...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.178.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.178.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rPF6ebPcdtWBCp6+J8qyOjAP/MwcImQFj4HR/EznutisNZ8FYTMWWhh6IB6nAje8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.178.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.178.0/index.min.mjs": "sha384-rPF6ebPcdtWBCp6+J8qyOjAP/MwcImQFj4HR/EznutisNZ8FYTMWWhh6IB6nAje8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.178.0/LICENSE
```

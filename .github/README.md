...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.435.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.435.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-f5XctFpq4CI/zabG87l9jUOGBH8E4TN8Evk1PgLjE43LbtmJ4nDGGgdkkDaMGCNF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.435.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.435.0/index.min.mjs": "sha384-f5XctFpq4CI/zabG87l9jUOGBH8E4TN8Evk1PgLjE43LbtmJ4nDGGgdkkDaMGCNF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.435.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.190.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.190.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cICmonElvhJZ2giYBSkXyavbfhzLppiWkfpwSNaBnE4OpXhB/wBd2GLBC8i757XT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.190.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.190.0/index.min.mjs": "sha384-cICmonElvhJZ2giYBSkXyavbfhzLppiWkfpwSNaBnE4OpXhB/wBd2GLBC8i757XT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.190.0/LICENSE
```

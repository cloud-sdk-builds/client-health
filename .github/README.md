...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.179.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.179.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pPpGBK+GP+cP12gKweFPrFwN00PCixSX7ZXlFhDYC0XiBUaPwgW+1YMEMAG5aDQW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.179.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.179.0/index.min.mjs": "sha384-pPpGBK+GP+cP12gKweFPrFwN00PCixSX7ZXlFhDYC0XiBUaPwgW+1YMEMAG5aDQW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.179.0/LICENSE
```

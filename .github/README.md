...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.261.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.261.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YwkJbFT8wrUNChwy0qZVdeYMgQ4L52D1miENadnCqTCqYCnjp12vTH45rjXlgz1Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.261.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.261.0/index.min.mjs": "sha384-YwkJbFT8wrUNChwy0qZVdeYMgQ4L52D1miENadnCqTCqYCnjp12vTH45rjXlgz1Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.261.0/LICENSE
```

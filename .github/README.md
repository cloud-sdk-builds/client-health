...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.957.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.957.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i87P+oMx4c0iRvcYOItFsRLMz/x/qVSbkKCmDwbNpWmPf9naxzDYezWAOcm45ALZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.957.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.957.0/index.min.mjs": "sha384-i87P+oMx4c0iRvcYOItFsRLMz/x/qVSbkKCmDwbNpWmPf9naxzDYezWAOcm45ALZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.957.0/LICENSE
```

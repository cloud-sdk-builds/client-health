...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.55.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.55.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZkQlyOB/TVfo9eJMGy74hIK5tZRerjIZt9Qbf5v6HoXhDMArroXdqhVHIO6TJdR/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.55.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.55.0/index.min.mjs": "sha384-ZkQlyOB/TVfo9eJMGy74hIK5tZRerjIZt9Qbf5v6HoXhDMArroXdqhVHIO6TJdR/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.55.0/LICENSE
```

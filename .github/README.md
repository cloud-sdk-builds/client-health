...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.254.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.254.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2cNfTWpFsm1AhUD0YoyW02YNjPuwuFE0bNMXcLMB/hi4qBbLXlodPPlc9xexrF1s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.254.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.254.0/index.min.mjs": "sha384-2cNfTWpFsm1AhUD0YoyW02YNjPuwuFE0bNMXcLMB/hi4qBbLXlodPPlc9xexrF1s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.254.0/LICENSE
```

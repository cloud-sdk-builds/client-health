...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.982.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.982.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Iw6p9dZZE6V0BMtMsIrTxtPHZEgKWmjjBJjtvf3Np3BIRsdc400mGuys9frRUQav
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.982.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.982.0/index.min.mjs": "sha384-Iw6p9dZZE6V0BMtMsIrTxtPHZEgKWmjjBJjtvf3Np3BIRsdc400mGuys9frRUQav"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.982.0/LICENSE
```

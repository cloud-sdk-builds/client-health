...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.862.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.862.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fEi26FscxOkp0Wcgbbg/Y8YXAXkfK0R7lmZgbblwVO6ycSbn8Uqg8uwXawZtNqfJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.862.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.862.0/index.min.mjs": "sha384-fEi26FscxOkp0Wcgbbg/Y8YXAXkfK0R7lmZgbblwVO6ycSbn8Uqg8uwXawZtNqfJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.862.0/LICENSE
```

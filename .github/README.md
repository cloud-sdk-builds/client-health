...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.234.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.234.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MMlNOreRK1R8BFwN1FclMt+SMiTjgKp+bKRBu/NSo0uLgwG1w0KjiOwdSrUWrSxc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.234.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.234.0/index.min.mjs": "sha384-MMlNOreRK1R8BFwN1FclMt+SMiTjgKp+bKRBu/NSo0uLgwG1w0KjiOwdSrUWrSxc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.234.0/LICENSE
```

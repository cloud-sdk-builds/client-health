...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.649.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.649.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YefCrpoEpVJc1LRaaUAW2sLIYxhWlUgMU5e/wiZOx/cFgAeiyJ78rFO012TTqVxy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.649.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.649.0/index.min.mjs": "sha384-YefCrpoEpVJc1LRaaUAW2sLIYxhWlUgMU5e/wiZOx/cFgAeiyJ78rFO012TTqVxy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.649.0/LICENSE
```

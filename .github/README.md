...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.43.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.43.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TU8xoGqdqWpBAam+RYubwUS+F47NmsGATznej7dUHeYmS86qjn9fBvQzf7WG/i2I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.43.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.43.0/index.min.mjs": "sha384-TU8xoGqdqWpBAam+RYubwUS+F47NmsGATznej7dUHeYmS86qjn9fBvQzf7WG/i2I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.43.0/LICENSE
```

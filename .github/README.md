...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.427.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.427.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hyHCImFvHp8CAquPRvRQ7g4iDEDv1ETB8Kl6pmqRkvjsNzzQztE8MX/kbCp4UHiK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.427.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.427.0/index.min.mjs": "sha384-hyHCImFvHp8CAquPRvRQ7g4iDEDv1ETB8Kl6pmqRkvjsNzzQztE8MX/kbCp4UHiK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.427.0/LICENSE
```

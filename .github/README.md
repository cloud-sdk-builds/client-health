...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.212.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.212.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bnvoCh3KZr/I5gApGreNcz0YUtgwAByIFml6nKLWOKimoUnG7/wH7Y/5D4+x7HUc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.212.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.212.0/index.min.mjs": "sha384-bnvoCh3KZr/I5gApGreNcz0YUtgwAByIFml6nKLWOKimoUnG7/wH7Y/5D4+x7HUc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.212.0/LICENSE
```

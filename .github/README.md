...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.731.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.731.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EXkaJipXqvdwa+vLpWTCk8NpQd7bsI9sigAddxPcbmcY5x0QTawfjI1fS6PP3Ue/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.731.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.731.0/index.min.mjs": "sha384-EXkaJipXqvdwa+vLpWTCk8NpQd7bsI9sigAddxPcbmcY5x0QTawfjI1fS6PP3Ue/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.731.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.56.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.56.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oG1RwPGomBm3M/Vb/EE5YJCJV7HntZmuyZ7KWZ+xWlEKJPrnUPcj6UcOg2GUPc0p
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.56.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.56.0/index.min.mjs": "sha384-oG1RwPGomBm3M/Vb/EE5YJCJV7HntZmuyZ7KWZ+xWlEKJPrnUPcj6UcOg2GUPc0p"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.56.0/LICENSE
```

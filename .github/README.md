...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.955.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.955.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XucvtoM+JYGCCwQyp9d9SJY7zCorMimAZm13UNZuCjKkWjYtQUleOyLzFe3vXgXf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.955.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.955.0/index.min.mjs": "sha384-XucvtoM+JYGCCwQyp9d9SJY7zCorMimAZm13UNZuCjKkWjYtQUleOyLzFe3vXgXf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.955.0/LICENSE
```

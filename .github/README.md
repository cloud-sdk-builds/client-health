...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.21.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.21.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UcMIk7YFXoY6xpHIT2cmds4haE997JiyvWaqz7Acev3ZbM6Ur0rr8wVHyJ4Ls6XD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.21.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.21.0/index.min.mjs": "sha384-UcMIk7YFXoY6xpHIT2cmds4haE997JiyvWaqz7Acev3ZbM6Ur0rr8wVHyJ4Ls6XD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.21.0/LICENSE
```

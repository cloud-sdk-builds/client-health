...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.668.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.668.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bEsjwWEHn7wP8xubEEgU2in6/LfIoqcfzUUnIz7YZaHdM8/XVcbCKEF7DvAomuwO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.668.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.668.0/index.min.mjs": "sha384-bEsjwWEHn7wP8xubEEgU2in6/LfIoqcfzUUnIz7YZaHdM8/XVcbCKEF7DvAomuwO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.668.0/LICENSE
```

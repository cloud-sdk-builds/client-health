...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.186.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.186.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5j9kBcWta2YIRZXqWnVte6wnqPNBIW9bcVfs6NVXaTY7DuOikCLDQo9QHms8rWBr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.186.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.186.0/index.min.mjs": "sha384-5j9kBcWta2YIRZXqWnVte6wnqPNBIW9bcVfs6NVXaTY7DuOikCLDQo9QHms8rWBr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.186.0/LICENSE
```

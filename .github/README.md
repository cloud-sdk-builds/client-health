...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.19.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.19.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aKDTUts/2w0yqbM7sICpSfpaBWgrmFg9ub+VXTtTHx0u5d2Uz098yUAN+efTkoie
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.19.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.19.0/index.min.mjs": "sha384-aKDTUts/2w0yqbM7sICpSfpaBWgrmFg9ub+VXTtTHx0u5d2Uz098yUAN+efTkoie"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.19.0/LICENSE
```

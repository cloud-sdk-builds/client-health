...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.162.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.162.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LC28W+BOuyaqwCUvf0LwS3ski/6KwjDOWcGyTLTYBAdjPMIgD3ZeEMTA6H9P15gt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.162.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.162.0/index.min.mjs": "sha384-LC28W+BOuyaqwCUvf0LwS3ski/6KwjDOWcGyTLTYBAdjPMIgD3ZeEMTA6H9P15gt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.162.0/LICENSE
```

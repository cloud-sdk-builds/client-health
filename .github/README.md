...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.606.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.606.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RJyx7Qbw1nHCTGKP5f2OJHm/Z/POFqWqEb7KPst24bv1qgJQO1oqgIkV7zIfCfra
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.606.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.606.0/index.min.mjs": "sha384-RJyx7Qbw1nHCTGKP5f2OJHm/Z/POFqWqEb7KPst24bv1qgJQO1oqgIkV7zIfCfra"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.606.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.775.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.775.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2vCdfLbJZnt2tu960avOPhqfvC14d3i/GFn8I4bhI6+E3Lv4+Tzxa2dxFtTB77zd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.775.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.775.0/index.min.mjs": "sha384-2vCdfLbJZnt2tu960avOPhqfvC14d3i/GFn8I4bhI6+E3Lv4+Tzxa2dxFtTB77zd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.775.0/LICENSE
```

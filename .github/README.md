...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.507.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.507.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3jK0hSkTqHQR0Y3szmDjfX6MLnmGVyEWdfTctUNE12BmSp9VkZRFSqRY3Hs74tVf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.507.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.507.0/index.min.mjs": "sha384-3jK0hSkTqHQR0Y3szmDjfX6MLnmGVyEWdfTctUNE12BmSp9VkZRFSqRY3Hs74tVf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.507.0/LICENSE
```

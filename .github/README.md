...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.48.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.48.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GtT+O4jXX4g+w3wgPSpT93Z0PlH3m74GXzz0EAtJCL8NF3vuZ1UwYo1jaZyehfam
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.48.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.48.0/index.min.mjs": "sha384-GtT+O4jXX4g+w3wgPSpT93Z0PlH3m74GXzz0EAtJCL8NF3vuZ1UwYo1jaZyehfam"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.48.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.100.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.100.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4nA+fMXQ+nbKFqezgUZBHhfzNGzwkNm1m2uBhbPlHxzzVleNV44qlHnkue/CPf08
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.100.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.100.0/index.min.mjs": "sha384-4nA+fMXQ+nbKFqezgUZBHhfzNGzwkNm1m2uBhbPlHxzzVleNV44qlHnkue/CPf08"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.100.0/LICENSE
```

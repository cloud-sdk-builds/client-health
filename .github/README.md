...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.199.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.199.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fLrVxbwKTUGtIzBzvX1yuzivIbYv2HuMorCiyktEaExj/ngrvcym5sED0QRnjTZq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.199.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.199.0/index.min.mjs": "sha384-fLrVxbwKTUGtIzBzvX1yuzivIbYv2HuMorCiyktEaExj/ngrvcym5sED0QRnjTZq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.199.0/LICENSE
```

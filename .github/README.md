...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.26.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.26.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QVzOeOP0I4kBvliQAe/EuXJSdP3IqCFSpsiGhj9hoXtY2XK4ckTj+N06gPuV81rJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.26.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.26.0/index.min.mjs": "sha384-QVzOeOP0I4kBvliQAe/EuXJSdP3IqCFSpsiGhj9hoXtY2XK4ckTj+N06gPuV81rJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.26.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.907.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.907.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vsY7Hs/kAewuay88/AhBMDhGy147C9PwyQGcITNZ0SUgjFz9RcO3tlbBC0BzwQDu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.907.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.907.0/index.min.mjs": "sha384-vsY7Hs/kAewuay88/AhBMDhGy147C9PwyQGcITNZ0SUgjFz9RcO3tlbBC0BzwQDu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.907.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1031.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1031.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZWKoxK8UbH7ueM+oDg82QAMOtwx43GEvry0yvsh+dorJdRX0I+9uPvxu0Zuneuqn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1031.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1031.0/index.min.mjs": "sha384-ZWKoxK8UbH7ueM+oDg82QAMOtwx43GEvry0yvsh+dorJdRX0I+9uPvxu0Zuneuqn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1031.0/LICENSE
```

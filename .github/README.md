...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.461.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.461.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UpoUrfBshaAPc8qaDGW2yP8OiGr5V9RPObviS9IQrPTZcwRlX7i3bQ3xdWW1E+zx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.461.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.461.0/index.min.mjs": "sha384-UpoUrfBshaAPc8qaDGW2yP8OiGr5V9RPObviS9IQrPTZcwRlX7i3bQ3xdWW1E+zx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.461.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.734.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.734.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YJweIPA/p9FP/+0qLhHgo/z5z5wVHZ6yPGVznQIxndnHHJmDYEny2GuAWN8fP9jo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.734.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.734.0/index.min.mjs": "sha384-YJweIPA/p9FP/+0qLhHgo/z5z5wVHZ6yPGVznQIxndnHHJmDYEny2GuAWN8fP9jo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.734.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1040.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1040.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lWokWJlVlrEC+9I9BHVyseWPABSVaBlGNd6EGzNtd/zLnaitPRXENuP6Zew5ShI+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1040.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1040.0/index.min.mjs": "sha384-lWokWJlVlrEC+9I9BHVyseWPABSVaBlGNd6EGzNtd/zLnaitPRXENuP6Zew5ShI+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1040.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.327.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.327.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZNJVAst4V3QA7y4/kBluDLKKimDMKtjGZq2b6ZitlfxyKg22m59DH/lhgipF6nBj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.327.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.327.0/index.min.mjs": "sha384-ZNJVAst4V3QA7y4/kBluDLKKimDMKtjGZq2b6ZitlfxyKg22m59DH/lhgipF6nBj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.327.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.40.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.40.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IKRg/y8SfOBTXf7m1PN4UzVmDFDRBbRVweQRAQ0+4uWNfchUP2WoBwo8jC91/EZj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.40.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.40.0/index.min.mjs": "sha384-IKRg/y8SfOBTXf7m1PN4UzVmDFDRBbRVweQRAQ0+4uWNfchUP2WoBwo8jC91/EZj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.40.0/LICENSE
```

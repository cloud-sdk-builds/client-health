...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.238.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.238.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3JV1U9G0GhuJcEWXHmq5EckjX44iBQo1jJ0TCuMg2+c2GeZciFE16PM6Y2IFtD5/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.238.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.238.0/index.min.mjs": "sha384-3JV1U9G0GhuJcEWXHmq5EckjX44iBQo1jJ0TCuMg2+c2GeZciFE16PM6Y2IFtD5/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.238.0/LICENSE
```

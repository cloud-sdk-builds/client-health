...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.556.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.556.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-88eFZK2TqQxFoVq4yVTkMaohZRA09L5RaZObCtvXbSjmIv74Qr6f95scIWB4yqfE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.556.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.556.0/index.min.mjs": "sha384-88eFZK2TqQxFoVq4yVTkMaohZRA09L5RaZObCtvXbSjmIv74Qr6f95scIWB4yqfE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.556.0/LICENSE
```

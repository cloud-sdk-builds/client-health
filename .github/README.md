...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.171.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.171.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-G/hAajiTT0jk3xKOvBS0HIXkN7gOuvt8k03IDQu8cZf3lzdCW8LZMAkLxXpEHtrn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.171.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.171.0/index.min.mjs": "sha384-G/hAajiTT0jk3xKOvBS0HIXkN7gOuvt8k03IDQu8cZf3lzdCW8LZMAkLxXpEHtrn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.171.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.290.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.290.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kgDersdZr1qQVXthSPlqqPsD6o2QdlhDJfdxMKBFm7/H9Yc6RZ6CY0VSl8PtXBsH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.290.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.290.0/index.min.mjs": "sha384-kgDersdZr1qQVXthSPlqqPsD6o2QdlhDJfdxMKBFm7/H9Yc6RZ6CY0VSl8PtXBsH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.290.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.159.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.159.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QZrXiEDjfj9k0V+b9PYgzvJ62XE54kfJMavIkUCnEtAc8XtONsBapsrVxlpHe0bw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.159.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.159.0/index.min.mjs": "sha384-QZrXiEDjfj9k0V+b9PYgzvJ62XE54kfJMavIkUCnEtAc8XtONsBapsrVxlpHe0bw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.159.0/LICENSE
```

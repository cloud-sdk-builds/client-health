...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.276.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.276.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RvYTUmjc7Kxgni0VBCto5G5Y3TSi5EzOuHuU9ovm68xuTNPDe3QP7JjgLJwNKS/6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.276.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.276.0/index.min.mjs": "sha384-RvYTUmjc7Kxgni0VBCto5G5Y3TSi5EzOuHuU9ovm68xuTNPDe3QP7JjgLJwNKS/6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.276.0/LICENSE
```

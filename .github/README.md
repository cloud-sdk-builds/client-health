...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.92.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.92.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ijs8p71UES0Uvm2e4TOim8w385r0UGRwCAlx2fTS8ePwWE/BywjQUJw20mnXp/9k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.92.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.92.0/index.min.mjs": "sha384-Ijs8p71UES0Uvm2e4TOim8w385r0UGRwCAlx2fTS8ePwWE/BywjQUJw20mnXp/9k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.92.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.193.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.193.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BUKx/zE20YKLrqidazxwmCdrX7BYKaxsC7w5tCnvGbizlaad4Dq9ornyS22x9858
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.193.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.193.0/index.min.mjs": "sha384-BUKx/zE20YKLrqidazxwmCdrX7BYKaxsC7w5tCnvGbizlaad4Dq9ornyS22x9858"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.193.0/LICENSE
```

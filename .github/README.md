...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.906.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.906.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uBhDoTaIVRWNDk3bU09d8LgcdOYL/nfWi6LnjvFZttePys68c6XvlMWGRz41Nlns
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.906.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.906.0/index.min.mjs": "sha384-uBhDoTaIVRWNDk3bU09d8LgcdOYL/nfWi6LnjvFZttePys68c6XvlMWGRz41Nlns"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.906.0/LICENSE
```

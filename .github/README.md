...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.33.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.33.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TK138aF34YuPAspJLiPZQkufVRG+QKrVe00g9bxE7cyewyQxEPT4MoB5+FzkXRor
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.33.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.33.0/index.min.mjs": "sha384-TK138aF34YuPAspJLiPZQkufVRG+QKrVe00g9bxE7cyewyQxEPT4MoB5+FzkXRor"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.33.0/LICENSE
```

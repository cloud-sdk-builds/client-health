...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.967.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.967.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tr1ya+S+CEO8XVjZI+xFl64vCrJf1FFMwegNzwFY8pSfdJaGkuD9X1bfv99PHnFU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.967.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.967.0/index.min.mjs": "sha384-tr1ya+S+CEO8XVjZI+xFl64vCrJf1FFMwegNzwFY8pSfdJaGkuD9X1bfv99PHnFU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.967.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.188.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.188.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Gg1xFD+39P/3JC2RHIB9OhBv5JScRRWf6bztWfPVFFZHzPuVcaVVVM2Anw8PuFdK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.188.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.188.0/index.min.mjs": "sha384-Gg1xFD+39P/3JC2RHIB9OhBv5JScRRWf6bztWfPVFFZHzPuVcaVVVM2Anw8PuFdK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.188.0/LICENSE
```

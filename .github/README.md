...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.386.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.386.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4F5o4R+XX/SJznH7XAyDINJjAY+bm+zloi0DrLqjQuJkbpcRTNM3a8qoxb41Qwff
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.386.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.386.0/index.min.mjs": "sha384-4F5o4R+XX/SJznH7XAyDINJjAY+bm+zloi0DrLqjQuJkbpcRTNM3a8qoxb41Qwff"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.386.0/LICENSE
```

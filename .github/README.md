...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.823.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.823.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1xYMhDfu8Fn4B/D6iApvmC7b4WFbYwJxKecKMFmyscO2sQwVqUJXH7uph/cW437l
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.823.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.823.0/index.min.mjs": "sha384-1xYMhDfu8Fn4B/D6iApvmC7b4WFbYwJxKecKMFmyscO2sQwVqUJXH7uph/cW437l"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.823.0/LICENSE
```

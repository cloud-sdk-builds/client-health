...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.839.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.839.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Jbhxoha+upzImvQAvpxMxHF1sVkEYG+AefXLQQc44DUV6gUPfB1yQtdDY3uJhbU+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.839.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.839.0/index.min.mjs": "sha384-Jbhxoha+upzImvQAvpxMxHF1sVkEYG+AefXLQQc44DUV6gUPfB1yQtdDY3uJhbU+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.839.0/LICENSE
```

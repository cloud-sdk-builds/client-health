...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.297.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.297.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iDBvGa7Lhbl2b1hftE+3v3NIzpPbif0DNzMdk6o9Rd3bjwZRyLeWgmdLQNZFD0nq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.297.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.297.0/index.min.mjs": "sha384-iDBvGa7Lhbl2b1hftE+3v3NIzpPbif0DNzMdk6o9Rd3bjwZRyLeWgmdLQNZFD0nq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.297.0/LICENSE
```

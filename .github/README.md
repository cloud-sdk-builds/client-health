...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.857.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.857.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-o5w9Wdz2TrVSrHJpJnVBpj0LWq8/IKKDLiI0kS1Rb0wgdUpIvgDAPVqmNE1WwsnN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.857.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.857.0/index.min.mjs": "sha384-o5w9Wdz2TrVSrHJpJnVBpj0LWq8/IKKDLiI0kS1Rb0wgdUpIvgDAPVqmNE1WwsnN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.857.0/LICENSE
```

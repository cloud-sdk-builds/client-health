...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.38.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.38.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-s8B7RFXMCWJycySPsLLiBa9kjhuB0xPw+/8BFsIeGrV7xPHRt8TRjSpW5n0aU7YS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.38.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.38.0/index.min.mjs": "sha384-s8B7RFXMCWJycySPsLLiBa9kjhuB0xPw+/8BFsIeGrV7xPHRt8TRjSpW5n0aU7YS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.38.0/LICENSE
```

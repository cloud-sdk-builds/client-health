...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.132.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.132.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GxQIUqn60CYni/SvOl3U5TVdkdHGjnOaBbUppdOxnXxkIMeuGwxfTIKFAxjLh+TH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.132.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.132.0/index.min.mjs": "sha384-GxQIUqn60CYni/SvOl3U5TVdkdHGjnOaBbUppdOxnXxkIMeuGwxfTIKFAxjLh+TH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.132.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.670.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.670.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Spfa4ZnDhiuA8iBY6AKRpYJjJqE1Muxmii7XHGzfTzelIluQ3MyrTScXUt27pq9D
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.670.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.670.0/index.min.mjs": "sha384-Spfa4ZnDhiuA8iBY6AKRpYJjJqE1Muxmii7XHGzfTzelIluQ3MyrTScXUt27pq9D"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.670.0/LICENSE
```

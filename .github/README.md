...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.347.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.347.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tjbGooY48gvWOJ5Gd4E+dl5zjxNzPOj1l3mBKsBHRfIwZYq6T2Wc8+uZXtf/4jmV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.347.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.347.0/index.min.mjs": "sha384-tjbGooY48gvWOJ5Gd4E+dl5zjxNzPOj1l3mBKsBHRfIwZYq6T2Wc8+uZXtf/4jmV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.347.0/LICENSE
```

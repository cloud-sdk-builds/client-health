...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.359.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.359.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZLNc2x8PGF+ywc/Rpk41tn2KXIiM/IS0RwJdyDQUDWIMNQyU93a/FoRdz07IW+nC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.359.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.359.0/index.min.mjs": "sha384-ZLNc2x8PGF+ywc/Rpk41tn2KXIiM/IS0RwJdyDQUDWIMNQyU93a/FoRdz07IW+nC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.359.0/LICENSE
```

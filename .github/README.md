...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.329.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.329.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NUr1Z8Qd1c3TuCBLoNQzGpxOtDlX3kIpYvX/6XibpQ/Sh6qLmEU3T/LFvAi0Yl3c
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.329.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.329.0/index.min.mjs": "sha384-NUr1Z8Qd1c3TuCBLoNQzGpxOtDlX3kIpYvX/6XibpQ/Sh6qLmEU3T/LFvAi0Yl3c"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.329.0/LICENSE
```

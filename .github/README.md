...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.281.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.281.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-j+pPGStfmsKOqfJNF1ncJsoFlxukBCsCG7Nmg23OhBajSge/GW6hVWHZx4Y+Ur2P
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.281.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.281.0/index.min.mjs": "sha384-j+pPGStfmsKOqfJNF1ncJsoFlxukBCsCG7Nmg23OhBajSge/GW6hVWHZx4Y+Ur2P"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.281.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.583.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.583.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6Tn+i+Joh5dBbt0JwbcDKkGUuvbW0YesquQizcPgq40IwK2vIHMbs2Cx1CyU2kYx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.583.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.583.0/index.min.mjs": "sha384-6Tn+i+Joh5dBbt0JwbcDKkGUuvbW0YesquQizcPgq40IwK2vIHMbs2Cx1CyU2kYx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.583.0/LICENSE
```

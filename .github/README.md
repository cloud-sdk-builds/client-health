...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.4.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.4.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-qglojVjmZLoimV0aFssVIy33cK/GNk8hHNyd9jctI+AIC4Q6nfrCNiDHbg7E4syZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.4.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.4.1/index.min.mjs": "sha384-qglojVjmZLoimV0aFssVIy33cK/GNk8hHNyd9jctI+AIC4Q6nfrCNiDHbg7E4syZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.4.1/LICENSE
```

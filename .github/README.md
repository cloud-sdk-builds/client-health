...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.998.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.998.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UcPZR/5P7jppMsQvggbPUZM+NTIAWI4gLZS0MU4fCcIyQnD7ea+OvTBsdroO/MwM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.998.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.998.0/index.min.mjs": "sha384-UcPZR/5P7jppMsQvggbPUZM+NTIAWI4gLZS0MU4fCcIyQnD7ea+OvTBsdroO/MwM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.998.0/LICENSE
```

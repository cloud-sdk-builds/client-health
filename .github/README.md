...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.259.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.259.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MhJAoOKPhKGZMOlJIwl9g2Vy/MXp+4j2p18uNFS5dalIM+QGMbcFjgviOB1z/07D
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.259.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.259.0/index.min.mjs": "sha384-MhJAoOKPhKGZMOlJIwl9g2Vy/MXp+4j2p18uNFS5dalIM+QGMbcFjgviOB1z/07D"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.259.0/LICENSE
```

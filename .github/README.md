...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1029.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1029.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9wqO/eYJGqjXsS7n5SqPPoH0B3PEw5U5v5AOO2bqpKhRbQEofCxfhjAypbcCPRy+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1029.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1029.0/index.min.mjs": "sha384-9wqO/eYJGqjXsS7n5SqPPoH0B3PEw5U5v5AOO2bqpKhRbQEofCxfhjAypbcCPRy+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1029.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.588.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.588.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/sWm01gfQXgu4qwzWXLC1Qdy/x7iDWdwfhygUHkFp1RAEBJ2CR8eGP/LY5yHhXB3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.588.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.588.0/index.min.mjs": "sha384-/sWm01gfQXgu4qwzWXLC1Qdy/x7iDWdwfhygUHkFp1RAEBJ2CR8eGP/LY5yHhXB3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.588.0/LICENSE
```

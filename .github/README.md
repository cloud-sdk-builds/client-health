...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.341.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.341.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z/RcIoLzBlDO1z7ob0H2JS4znHaVpxxqeX89MkolZ/O3y+7DBXgeb1CFEQk1BLCm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.341.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.341.0/index.min.mjs": "sha384-Z/RcIoLzBlDO1z7ob0H2JS4znHaVpxxqeX89MkolZ/O3y+7DBXgeb1CFEQk1BLCm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.341.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.621.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.621.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zj4z2/akt1ZE3swrZJe7qJeCa1swc/7wctQ1ISK/5GJhI3wZVzGkHcN8NuwHgtIk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.621.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.621.0/index.min.mjs": "sha384-zj4z2/akt1ZE3swrZJe7qJeCa1swc/7wctQ1ISK/5GJhI3wZVzGkHcN8NuwHgtIk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.621.0/LICENSE
```

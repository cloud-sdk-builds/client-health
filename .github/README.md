...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.161.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.161.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v+VGMrRqb9aHq+XTNjU6uHXS2xWZtP0GzG/P2gjmrT6eb5hmKL2DjrS3RCfDX5XW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.161.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.161.0/index.min.mjs": "sha384-v+VGMrRqb9aHq+XTNjU6uHXS2xWZtP0GzG/P2gjmrT6eb5hmKL2DjrS3RCfDX5XW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.161.0/LICENSE
```

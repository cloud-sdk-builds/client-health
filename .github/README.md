...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.236.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.236.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-97g0/KWQgU27qB6t4PPw1jbzcBdCQZfBHBSTGxYUDc/+FEA8XR59cdTfElm6Pn2u
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.236.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.236.0/index.min.mjs": "sha384-97g0/KWQgU27qB6t4PPw1jbzcBdCQZfBHBSTGxYUDc/+FEA8XR59cdTfElm6Pn2u"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.236.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.731.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.731.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-EtphavPGFNrLi5aSqJ0YUARXaLpmqdsPiqIIlmlLoKb+403MDaUk5biJfGFtpFvK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.731.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.731.1/index.min.mjs": "sha384-EtphavPGFNrLi5aSqJ0YUARXaLpmqdsPiqIIlmlLoKb+403MDaUk5biJfGFtpFvK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.731.1/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.677.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.677.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JS8r6akfqqTfCbIH49okGQBWuQcuGB2ht0DTDJflRKhVxAw3P4dnXbqb/d/N9Mca
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.677.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.677.0/index.min.mjs": "sha384-JS8r6akfqqTfCbIH49okGQBWuQcuGB2ht0DTDJflRKhVxAw3P4dnXbqb/d/N9Mca"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.677.0/LICENSE
```

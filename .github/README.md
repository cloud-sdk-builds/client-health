...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.846.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.846.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K/TI4P8AhlO0YAsh3S1dJCOQzwAjXaHJwduJE0p41LrIzyQ1MWMYha5mdTwOli3t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.846.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.846.0/index.min.mjs": "sha384-K/TI4P8AhlO0YAsh3S1dJCOQzwAjXaHJwduJE0p41LrIzyQ1MWMYha5mdTwOli3t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.846.0/LICENSE
```

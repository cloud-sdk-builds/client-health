...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.567.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.567.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iPQK12LupqL2vWrK+sC85DwAzKg4zydm1qVfBlRTBIS1BsRxvsIprq4MB3xRznvM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.567.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.567.0/index.min.mjs": "sha384-iPQK12LupqL2vWrK+sC85DwAzKg4zydm1qVfBlRTBIS1BsRxvsIprq4MB3xRznvM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.567.0/LICENSE
```

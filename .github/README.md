...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.201.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.201.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2MO1ltMZltOnOTI/HmDhtiMh5JDQPzQAtxAEK2kK/C4crGNbvkiyOzj8oafLyZ3M
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.201.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.201.0/index.min.mjs": "sha384-2MO1ltMZltOnOTI/HmDhtiMh5JDQPzQAtxAEK2kK/C4crGNbvkiyOzj8oafLyZ3M"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.201.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.278.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.278.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tMhIr1RqKOhrbC7RKU7kGZGky0ftwrl+3FqVZuE9h/eGkVLaExwAJQ2UsHSGMKjD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.278.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.278.0/index.min.mjs": "sha384-tMhIr1RqKOhrbC7RKU7kGZGky0ftwrl+3FqVZuE9h/eGkVLaExwAJQ2UsHSGMKjD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.278.0/LICENSE
```

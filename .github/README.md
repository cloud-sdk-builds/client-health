...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.978.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.978.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fYymHBYctxBg5XHr4yCqcsGURlkcFQhTm5vMm94evMqBBegmRNO0mSechDQH/gMZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.978.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.978.0/index.min.mjs": "sha384-fYymHBYctxBg5XHr4yCqcsGURlkcFQhTm5vMm94evMqBBegmRNO0mSechDQH/gMZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.978.0/LICENSE
```

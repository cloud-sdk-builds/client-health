...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.109.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.109.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-o2Cv/c9uVUnORGS2muLSnTuu8KoZYAdBjjkVGptP24yMb/mgR3Y/z0CobbVeup9A
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.109.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.109.0/index.min.mjs": "sha384-o2Cv/c9uVUnORGS2muLSnTuu8KoZYAdBjjkVGptP24yMb/mgR3Y/z0CobbVeup9A"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.109.0/LICENSE
```

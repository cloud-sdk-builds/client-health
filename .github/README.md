...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.913.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.913.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-y0JUCsP6TX8JaUG66m6NJ2B9muemGa/CV4tnnWuBQc931zdfFoSUJZyXXzmlg6Pu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.913.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.913.0/index.min.mjs": "sha384-y0JUCsP6TX8JaUG66m6NJ2B9muemGa/CV4tnnWuBQc931zdfFoSUJZyXXzmlg6Pu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.913.0/LICENSE
```

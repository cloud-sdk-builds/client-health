...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.316.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.316.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MTcneR/gIuh98BFwkUL4tk5z+NFu2zDiHr98z2NHNz4dzee3nrNuZ10n+HnqOj4+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.316.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.316.0/index.min.mjs": "sha384-MTcneR/gIuh98BFwkUL4tk5z+NFu2zDiHr98z2NHNz4dzee3nrNuZ10n+HnqOj4+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.316.0/LICENSE
```

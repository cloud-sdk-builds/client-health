...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.999.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.999.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Scjnhd6Z4BO3gjPYCnQEniWbx+ZfYiWAlE6msdHb/On7LdP1dAxnW0teVTkmCeM8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.999.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.999.0/index.min.mjs": "sha384-Scjnhd6Z4BO3gjPYCnQEniWbx+ZfYiWAlE6msdHb/On7LdP1dAxnW0teVTkmCeM8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.999.0/LICENSE
```

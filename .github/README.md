...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.271.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.271.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VGxe74bsFkslBXM7ChgrhvrSkVg4xhMxuAOGg+jJCzYQ686jWxXy4NHMWWZ0H6hs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.271.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.271.0/index.min.mjs": "sha384-VGxe74bsFkslBXM7ChgrhvrSkVg4xhMxuAOGg+jJCzYQ686jWxXy4NHMWWZ0H6hs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.271.0/LICENSE
```

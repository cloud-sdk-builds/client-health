...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.150.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.150.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tJm2ETd+wXr6QrfWRWr8lmlAYWm8siBsUWQAVHC3MUqQj5UpM25npebLRP6yTjLT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.150.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.150.0/index.min.mjs": "sha384-tJm2ETd+wXr6QrfWRWr8lmlAYWm8siBsUWQAVHC3MUqQj5UpM25npebLRP6yTjLT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.150.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.350.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.350.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LVbsD2BnF4cm4TtPSdtp14T+O1/TqPajFuCwurEe3HUTo3T44v5+/nYloqv0GaMw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.350.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.350.0/index.min.mjs": "sha384-LVbsD2BnF4cm4TtPSdtp14T+O1/TqPajFuCwurEe3HUTo3T44v5+/nYloqv0GaMw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.350.0/LICENSE
```

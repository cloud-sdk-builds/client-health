...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.620.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.620.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-dJN8lwMrT8Gbxl5CrNKs+MrScW7vnswhLdEcM872yanT5WOk2li/V8fa9vKlwwsm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.620.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.620.1/index.min.mjs": "sha384-dJN8lwMrT8Gbxl5CrNKs+MrScW7vnswhLdEcM872yanT5WOk2li/V8fa9vKlwwsm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.620.1/LICENSE
```

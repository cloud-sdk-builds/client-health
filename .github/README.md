...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.983.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.983.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YilpYRYl7kQ+LaLw+dAw0FycPAkBdPQRcz3ysSnJyfkjKWsx/cfKbu92rJh5iB+X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.983.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.983.0/index.min.mjs": "sha384-YilpYRYl7kQ+LaLw+dAw0FycPAkBdPQRcz3ysSnJyfkjKWsx/cfKbu92rJh5iB+X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.983.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.423.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.423.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9WLl95hIy3fugYPw8Fr0JGZvVZDLrFUk3T+KyL44Ee/77Ri6tSfaZyEPODSf4990
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.423.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.423.0/index.min.mjs": "sha384-9WLl95hIy3fugYPw8Fr0JGZvVZDLrFUk3T+KyL44Ee/77Ri6tSfaZyEPODSf4990"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.423.0/LICENSE
```

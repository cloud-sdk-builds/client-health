...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.990.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.990.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-H8ChMk9Yf4UBhsJa60UziD7eukaTYMx1F8N5r4sjyuhbGWYMUsZlzMDfKlzrYI0a
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.990.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.990.0/index.min.mjs": "sha384-H8ChMk9Yf4UBhsJa60UziD7eukaTYMx1F8N5r4sjyuhbGWYMUsZlzMDfKlzrYI0a"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.990.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.414.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.414.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ln9pBCWNJPDi0fnBtqeipWaJ/kmLO6B+acGex/c7m2Hlxw78wj1FYgmj8Zx4MLHb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.414.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.414.0/index.min.mjs": "sha384-ln9pBCWNJPDi0fnBtqeipWaJ/kmLO6B+acGex/c7m2Hlxw78wj1FYgmj8Zx4MLHb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.414.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.17.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.17.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-44T3hvUHzBF2q1PY8zPcF098OVYhuUKpYdHBAEy8ZiPg+f/qcp0IrWUGnRloIVvU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.17.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.17.0/index.min.mjs": "sha384-44T3hvUHzBF2q1PY8zPcF098OVYhuUKpYdHBAEy8ZiPg+f/qcp0IrWUGnRloIVvU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.17.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.370.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.370.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JI8kxSsiD4kulXfDjJjhzwtT1YOaOpiNNyI0kpqktLUY1u5hp1pQrgHQ/4buw8Mz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.370.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.370.0/index.min.mjs": "sha384-JI8kxSsiD4kulXfDjJjhzwtT1YOaOpiNNyI0kpqktLUY1u5hp1pQrgHQ/4buw8Mz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.370.0/LICENSE
```

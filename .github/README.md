...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.377.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.377.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8ByQD1uoIYZjqFg/+hVvQDqMN6++ibpseDi/JWPY0zeR6sYJGNzAqDm7zwwZDuw9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.377.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.377.0/index.min.mjs": "sha384-8ByQD1uoIYZjqFg/+hVvQDqMN6++ibpseDi/JWPY0zeR6sYJGNzAqDm7zwwZDuw9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.377.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.883.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.883.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FLRf60lx+d4Nfw3Mtgzi9TBni6n35VBLxHrA9a9GQzohnEH7lTniHwUzQiJuZnmA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.883.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.883.0/index.min.mjs": "sha384-FLRf60lx+d4Nfw3Mtgzi9TBni6n35VBLxHrA9a9GQzohnEH7lTniHwUzQiJuZnmA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.883.0/LICENSE
```

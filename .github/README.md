...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.856.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.856.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YZLwvmol/d3O9wK+HNgcF72ZLydVneDDQ7AyYgyVXSezuC8w0ib8ABu9hKfI+6Vp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.856.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.856.0/index.min.mjs": "sha384-YZLwvmol/d3O9wK+HNgcF72ZLydVneDDQ7AyYgyVXSezuC8w0ib8ABu9hKfI+6Vp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.856.0/LICENSE
```

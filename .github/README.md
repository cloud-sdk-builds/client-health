...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.74.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.74.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vzi8plNCdG7ZbvkC4risXdJUQd50aWhIhNZdZuUfupffMt7M1b2PzYzHX37syAGe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.74.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.74.0/index.min.mjs": "sha384-vzi8plNCdG7ZbvkC4risXdJUQd50aWhIhNZdZuUfupffMt7M1b2PzYzHX37syAGe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.74.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.552.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.552.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2n+TDx86wqSUhLEVmC4uuUZnWt9lAwvkfyTWj/mHUrgGu5Du2zV/oUC+2glCTvGR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.552.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.552.0/index.min.mjs": "sha384-2n+TDx86wqSUhLEVmC4uuUZnWt9lAwvkfyTWj/mHUrgGu5Du2zV/oUC+2glCTvGR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.552.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1001.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1001.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VFetYimHgg6B4VHcxpJ5O8HtxVcEOcWTXHmeQbRg45nvDkwHeTloUR+BfhpZcR1c
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1001.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1001.0/index.min.mjs": "sha384-VFetYimHgg6B4VHcxpJ5O8HtxVcEOcWTXHmeQbRg45nvDkwHeTloUR+BfhpZcR1c"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1001.0/LICENSE
```

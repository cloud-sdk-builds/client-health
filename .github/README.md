...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.325.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.325.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CcRTeGsH7u3s8a0a3Zh1Unfldp4u6g0gGm6To3q07qDUzlIlCJJOb9a7WityuH+K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.325.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.325.0/index.min.mjs": "sha384-CcRTeGsH7u3s8a0a3Zh1Unfldp4u6g0gGm6To3q07qDUzlIlCJJOb9a7WityuH+K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.325.0/LICENSE
```

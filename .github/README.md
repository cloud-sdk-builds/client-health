...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.879.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.879.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3OhgT8/3EpGNDvT4caXyY3MwSpFfNTLcpg6qS6JeX9IsPq7iurIcUa1OMX0kMhRh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.879.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.879.0/index.min.mjs": "sha384-3OhgT8/3EpGNDvT4caXyY3MwSpFfNTLcpg6qS6JeX9IsPq7iurIcUa1OMX0kMhRh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.879.0/LICENSE
```

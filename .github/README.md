...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.342.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.342.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RNEOlhUkDwkmA+E28OPfoS0yU6VcmFW1JoIq+Jf73Db6/QkXhOHdny15LV0TqGiZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.342.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.342.0/index.min.mjs": "sha384-RNEOlhUkDwkmA+E28OPfoS0yU6VcmFW1JoIq+Jf73Db6/QkXhOHdny15LV0TqGiZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.342.0/LICENSE
```

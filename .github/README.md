...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.131.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.131.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/DoxTobBK252yguSi+1LUTBGV+KfmIF8QyeMGQcb03fTyYmB4Zrk+825CFmff6AJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.131.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.131.0/index.min.mjs": "sha384-/DoxTobBK252yguSi+1LUTBGV+KfmIF8QyeMGQcb03fTyYmB4Zrk+825CFmff6AJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.131.0/LICENSE
```

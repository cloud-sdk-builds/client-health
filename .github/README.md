...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.964.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.964.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uN2KqOJpX3wgExxHe1mMKBvztyvUnCPunxv8VGO/41GdJsVc6DL106fNn2fUn0nl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.964.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.964.0/index.min.mjs": "sha384-uN2KqOJpX3wgExxHe1mMKBvztyvUnCPunxv8VGO/41GdJsVc6DL106fNn2fUn0nl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.964.0/LICENSE
```

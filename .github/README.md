...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.478.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.478.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4whcAkfTA68P6CEExMMpJkJ0XxkydpTgpBI5YbJabELvzTuHOnTq4lKIEYQBc2L/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.478.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.478.0/index.min.mjs": "sha384-4whcAkfTA68P6CEExMMpJkJ0XxkydpTgpBI5YbJabELvzTuHOnTq4lKIEYQBc2L/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.478.0/LICENSE
```

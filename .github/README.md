...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.441.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.441.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DxojbjsCW/5KhYnjE36zmE9mf7Kb/jRETzzQhoxwhbw/umRbPx8bx4d/ByO8lcv4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.441.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.441.0/index.min.mjs": "sha384-DxojbjsCW/5KhYnjE36zmE9mf7Kb/jRETzzQhoxwhbw/umRbPx8bx4d/ByO8lcv4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.441.0/LICENSE
```

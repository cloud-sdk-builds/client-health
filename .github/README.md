...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.24.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.24.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LtJ+nGoEb+7nrSlVJ+I9MGlLN7KeGRWs5e14+40a0WLkhgECx/kxPuke95QQIfeS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.24.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.24.0/index.min.mjs": "sha384-LtJ+nGoEb+7nrSlVJ+I9MGlLN7KeGRWs5e14+40a0WLkhgECx/kxPuke95QQIfeS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.24.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.713.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.713.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QrFyacfP0waU042K/ta2w8TmYxNsj2fvlMqu9WC+HlEr67nzFq6uXY43NexKE/Z4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.713.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.713.0/index.min.mjs": "sha384-QrFyacfP0waU042K/ta2w8TmYxNsj2fvlMqu9WC+HlEr67nzFq6uXY43NexKE/Z4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.713.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.886.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.886.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-50arLHBb6VncLjARJSfcMASsQo6ii5zAtd+gqLoGabjkWBsb9GF3mNAnp4W+04xK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.886.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.886.0/index.min.mjs": "sha384-50arLHBb6VncLjARJSfcMASsQo6ii5zAtd+gqLoGabjkWBsb9GF3mNAnp4W+04xK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.886.0/LICENSE
```

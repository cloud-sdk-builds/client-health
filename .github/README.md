...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.468.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.468.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Jg0CPvPHGISNnKDbrTjya3vp8JPFwjX1UzMzLtHpSLVglukp3IFbiZ6rMwbFC1iY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.468.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.468.0/index.min.mjs": "sha384-Jg0CPvPHGISNnKDbrTjya3vp8JPFwjX1UzMzLtHpSLVglukp3IFbiZ6rMwbFC1iY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.468.0/LICENSE
```

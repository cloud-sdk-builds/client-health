...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.709.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.709.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iISNs9tvIkLwnbNMnc58Kdego5gJlKXTj+iJ1w/idM78vxRLjD9Nhj3TRPS0602d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.709.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.709.0/index.min.mjs": "sha384-iISNs9tvIkLwnbNMnc58Kdego5gJlKXTj+iJ1w/idM78vxRLjD9Nhj3TRPS0602d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.709.0/LICENSE
```

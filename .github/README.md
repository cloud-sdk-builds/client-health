...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.198.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.198.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v9U6wxKbCZp/UuIcfzu94k3jTTZ2PETWy86IsVt1ax+8sopiLEC0azvxzySc6fsq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.198.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.198.0/index.min.mjs": "sha384-v9U6wxKbCZp/UuIcfzu94k3jTTZ2PETWy86IsVt1ax+8sopiLEC0azvxzySc6fsq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.198.0/LICENSE
```

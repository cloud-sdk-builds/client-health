...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.686.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.686.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Po5cKRCdXQvNEm7pgFvYCehJmrPOc6INa4NNdrMfs/bbljgMBuFw5L4w/3DyKWlR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.686.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.686.0/index.min.mjs": "sha384-Po5cKRCdXQvNEm7pgFvYCehJmrPOc6INa4NNdrMfs/bbljgMBuFw5L4w/3DyKWlR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.686.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.947.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.947.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LM1q0NzGMRS8C9pQiROX2nKKUHH/HX1GLhCLvo4OkNaEnT7PLKiMshQroUaeDUtL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.947.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.947.0/index.min.mjs": "sha384-LM1q0NzGMRS8C9pQiROX2nKKUHH/HX1GLhCLvo4OkNaEnT7PLKiMshQroUaeDUtL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.947.0/LICENSE
```

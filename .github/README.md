...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.430.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.430.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DgxSt8ftg8Rb1LstIeDTlksPruaaFCzs2RyKwA3plmqameujRp7TEwS1C7uVNnR+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.430.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.430.0/index.min.mjs": "sha384-DgxSt8ftg8Rb1LstIeDTlksPruaaFCzs2RyKwA3plmqameujRp7TEwS1C7uVNnR+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.430.0/LICENSE
```

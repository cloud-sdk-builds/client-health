...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1039.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1039.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nvxS2kQHX2KMQEfRkJccsa7LxRxOB5si53ymC7pen6nF00ivNpnNMyyfV+aLDyJ+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1039.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1039.0/index.min.mjs": "sha384-nvxS2kQHX2KMQEfRkJccsa7LxRxOB5si53ymC7pen6nF00ivNpnNMyyfV+aLDyJ+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1039.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1028.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1028.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8UBRm2APz+wUm0xH2N9anrVKSgtvNhZhTRHMx+dokEgSNyefQbPOxICB4uN7Rv9t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1028.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1028.0/index.min.mjs": "sha384-8UBRm2APz+wUm0xH2N9anrVKSgtvNhZhTRHMx+dokEgSNyefQbPOxICB4uN7Rv9t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1028.0/LICENSE
```

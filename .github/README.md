...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.41.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.41.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-g0yaB/BVJBnWksj4f362AsS4JtniOJufCRUzJ/nJ2/C8hv6qtXq3cwoIYNhWXL1j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.41.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.41.0/index.min.mjs": "sha384-g0yaB/BVJBnWksj4f362AsS4JtniOJufCRUzJ/nJ2/C8hv6qtXq3cwoIYNhWXL1j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.41.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.81.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.81.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gCZGWZvtHK4mrzstPHLl8y6IetvarNaq8Axf/WyFFB2I7w9sh+lI7C5APvEan8OM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.81.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.81.0/index.min.mjs": "sha384-gCZGWZvtHK4mrzstPHLl8y6IetvarNaq8Axf/WyFFB2I7w9sh+lI7C5APvEan8OM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.81.0/LICENSE
```

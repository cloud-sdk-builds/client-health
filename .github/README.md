...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.78.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.78.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PhIafx7nLQAKp/+vy6WL+GzNmy1G7UVPHZ6wPq6liiKhZML5wuSWJA5U9DwVUHZV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.78.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.78.0/index.min.mjs": "sha384-PhIafx7nLQAKp/+vy6WL+GzNmy1G7UVPHZ6wPq6liiKhZML5wuSWJA5U9DwVUHZV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.78.0/LICENSE
```

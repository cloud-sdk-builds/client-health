...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.991.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.991.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dFAaWMlsv5d7ZEP1Qsdzs2lFB2fKxsx75ki3CN414uv18diOqxz+dtmf8fpp8DnP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.991.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.991.0/index.min.mjs": "sha384-dFAaWMlsv5d7ZEP1Qsdzs2lFB2fKxsx75ki3CN414uv18diOqxz+dtmf8fpp8DnP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.991.0/LICENSE
```

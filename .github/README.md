...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.208.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.208.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uzb1BWoKsdW98jOGYpBhrC2xMHcqudhar9xDp01m+gQlDbYFDiJt2x0OtEwHNyRE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.208.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.208.0/index.min.mjs": "sha384-uzb1BWoKsdW98jOGYpBhrC2xMHcqudhar9xDp01m+gQlDbYFDiJt2x0OtEwHNyRE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.208.0/LICENSE
```

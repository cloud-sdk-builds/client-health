...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.200.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.200.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CLmso0w5B3APmFlMOb38HArVCHz8T5/whACwkvj28kphn1NhXYg9U0RAz80UFEjE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.200.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.200.0/index.min.mjs": "sha384-CLmso0w5B3APmFlMOb38HArVCHz8T5/whACwkvj28kphn1NhXYg9U0RAz80UFEjE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.200.0/LICENSE
```

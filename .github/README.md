...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.896.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.896.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gqH6Qd7OqEohc9ai4kLI9D/ckDrSbzpapCr1Glr3873EXD0J8Vebwu3V6T+4nozY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.896.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.896.0/index.min.mjs": "sha384-gqH6Qd7OqEohc9ai4kLI9D/ckDrSbzpapCr1Glr3873EXD0J8Vebwu3V6T+4nozY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.896.0/LICENSE
```

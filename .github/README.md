...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.31.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.31.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bYEm8wHIvEUxYfa/wM4cs+0CFZVpQjkubpU3nRpc50QPGS4sGV6+nWW720lvS3Su
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.31.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.31.0/index.min.mjs": "sha384-bYEm8wHIvEUxYfa/wM4cs+0CFZVpQjkubpU3nRpc50QPGS4sGV6+nWW720lvS3Su"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.31.0/LICENSE
```

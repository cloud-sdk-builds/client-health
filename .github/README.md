...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.9.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.9.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wzcGu924589Ce1cPaFVW8b919w7v5t1zKTl29f16dwWUSIZfE3wdF2syEOiynEMx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.9.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.9.0/index.min.mjs": "sha384-wzcGu924589Ce1cPaFVW8b919w7v5t1zKTl29f16dwWUSIZfE3wdF2syEOiynEMx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.9.0/LICENSE
```

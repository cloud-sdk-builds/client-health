...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.935.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.935.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+2SD0j6Hmx9exR71q69VV+ZsUB4zw74ARkqn3zHnFShmP+lTHDMjDjXn1iUTM6XO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.935.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.935.0/index.min.mjs": "sha384-+2SD0j6Hmx9exR71q69VV+ZsUB4zw74ARkqn3zHnFShmP+lTHDMjDjXn1iUTM6XO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.935.0/LICENSE
```

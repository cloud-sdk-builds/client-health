...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.36.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.36.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-FvZ2L7b2eiVecloXvgU9uc8d0kyA92ufxmUaA146zDk/Vy/aZ+0ypsqjF2YroW7e
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.36.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.36.1/index.min.mjs": "sha384-FvZ2L7b2eiVecloXvgU9uc8d0kyA92ufxmUaA146zDk/Vy/aZ+0ypsqjF2YroW7e"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.36.1/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.195.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.195.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xFwhmVzV366Bdd755d3k3JZoxKTo0ybghWqcrFjlX3RJNvYI29DYm3t1MgZvXoWS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.195.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.195.0/index.min.mjs": "sha384-xFwhmVzV366Bdd755d3k3JZoxKTo0ybghWqcrFjlX3RJNvYI29DYm3t1MgZvXoWS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.195.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.622.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.622.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nerLCev9G4/30NJ8+oGchamrSvwx9A6TORCbuG93eh7dsqYHh2FIbfxG4oKMQNie
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.622.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.622.0/index.min.mjs": "sha384-nerLCev9G4/30NJ8+oGchamrSvwx9A6TORCbuG93eh7dsqYHh2FIbfxG4oKMQNie"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.622.0/LICENSE
```

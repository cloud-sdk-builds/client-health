...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.223.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.223.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V2Xe1h4o2JsePbHLkDRcpHbIKoTK6qCJKXT/DW8nGAgBMscWFeqHSeglUHLjBGCb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.223.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.223.0/index.min.mjs": "sha384-V2Xe1h4o2JsePbHLkDRcpHbIKoTK6qCJKXT/DW8nGAgBMscWFeqHSeglUHLjBGCb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.223.0/LICENSE
```

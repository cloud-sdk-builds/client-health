...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6Ve7UzGrV0Qc29Nz4sL8+IoQaJzclX3uSAV4kGRf6iLOThSMZXOyRwTdGSoBtOmv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1.0/index.min.mjs": "sha384-6Ve7UzGrV0Qc29Nz4sL8+IoQaJzclX3uSAV4kGRf6iLOThSMZXOyRwTdGSoBtOmv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1.0/LICENSE
```

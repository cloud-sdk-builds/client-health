...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.310.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.310.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OZsNElmLIkmwv9Y5Fe95Ad+gZakw/GHyZalUJ1lLVZwSwKcyJ2wsbyM8jXbYp7eK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.310.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.310.0/index.min.mjs": "sha384-OZsNElmLIkmwv9Y5Fe95Ad+gZakw/GHyZalUJ1lLVZwSwKcyJ2wsbyM8jXbYp7eK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.310.0/LICENSE
```

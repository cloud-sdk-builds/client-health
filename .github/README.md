...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.1013.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1013.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5da2ZMVpnz/JeWTj7oaVqlS6RCGIVXuh+bSeYhEBpVApt8xO0shtJT6mqPN0Mwtp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1013.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.1013.0/index.min.mjs": "sha384-5da2ZMVpnz/JeWTj7oaVqlS6RCGIVXuh+bSeYhEBpVApt8xO0shtJT6mqPN0Mwtp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.1013.0/LICENSE
```

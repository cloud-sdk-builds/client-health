...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.774.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.774.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ycCOFjDKedBKv0YSEx+z8Vy5btd/SSWUlIqM+s2Hi04MoJSNGbcUc/uviHBH8DXE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.774.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.774.0/index.min.mjs": "sha384-ycCOFjDKedBKv0YSEx+z8Vy5btd/SSWUlIqM+s2Hi04MoJSNGbcUc/uviHBH8DXE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.774.0/LICENSE
```

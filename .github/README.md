...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.966.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.966.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GNQjfgiWz31XagwNP//af+XGudDqrx2c4tKo5UPvJ4Ehb/wYYkNwICuBUHxtzooO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.966.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.966.0/index.min.mjs": "sha384-GNQjfgiWz31XagwNP//af+XGudDqrx2c4tKo5UPvJ4Ehb/wYYkNwICuBUHxtzooO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.966.0/LICENSE
```

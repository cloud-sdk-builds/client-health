...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.474.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.474.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qFlHN0aIZd+NvlHr1OqSyFC+15x04TWARDuBkKKjFilM3lkSAwIfx5H+dTugkYy6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.474.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.474.0/index.min.mjs": "sha384-qFlHN0aIZd+NvlHr1OqSyFC+15x04TWARDuBkKKjFilM3lkSAwIfx5H+dTugkYy6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.474.0/LICENSE
```

...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.682.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.682.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5J7KGPs/N4OrkMMMg7IvzVdYL62Ytd+WnFduHWvO6eFFAOs1Dr39xPOJsflgW9sH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.682.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.682.0/index.min.mjs": "sha384-5J7KGPs/N4OrkMMMg7IvzVdYL62Ytd+WnFduHWvO6eFFAOs1Dr39xPOJsflgW9sH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.682.0/LICENSE
```

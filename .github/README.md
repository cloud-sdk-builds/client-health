...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.654.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.654.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xw67em1nHmkPHLWLi1BluikWf2TKR4ytXUukab+lLl8pJtCOTBTFoq/oAnbfP1VX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.654.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.654.0/index.min.mjs": "sha384-xw67em1nHmkPHLWLi1BluikWf2TKR4ytXUukab+lLl8pJtCOTBTFoq/oAnbfP1VX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.654.0/LICENSE
```

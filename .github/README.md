...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.15.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.15.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LbttUG385UMFCL0SiMf8WLxs5iyyqKbejyusuZJSliT86rRJ+vVdlOdYO9jy9WhB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.15.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.15.0/index.min.mjs": "sha384-LbttUG385UMFCL0SiMf8WLxs5iyyqKbejyusuZJSliT86rRJ+vVdlOdYO9jy9WhB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.15.0/LICENSE
```

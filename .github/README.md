...
[`@aws-sdk/client-health`](https://www.npmjs.com/package/@aws-sdk/client-health/v/3.971.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.971.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Sz/VBGaoOaNY2kC2SMYceBmVYax91Ysohbidl0M7PdfUdB/DfvhU5kgLQNdCTHJk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-health": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.971.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-health@3.971.0/index.min.mjs": "sha384-Sz/VBGaoOaNY2kC2SMYceBmVYax91Ysohbidl0M7PdfUdB/DfvhU5kgLQNdCTHJk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-health/blob/refs/tags/3.971.0/LICENSE
```
